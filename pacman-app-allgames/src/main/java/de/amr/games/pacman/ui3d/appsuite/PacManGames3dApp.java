...
public class PacManGames3dApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        THE_UI.gameUIConfigManager().set(GameVariant.PACMAN, new ArcadePacMan_UIConfig());
        THE_UI.gameUIConfigManager().set(GameVariant.MS_PACMAN, new ArcadeMsPacMan_UIConfig());
        THE_UI.gameUIConfigManager().set(GameVariant.MS_PACMAN_TENGEN, new TengenMsPacMan_UIConfig());
        THE_UI.gameUIConfigManager().set(GameVariant.PACMAN_XXL, new PacManXXL_PacMan_UIConfig());
        THE_UI.gameUIConfigManager().set(GameVariant.MS_PACMAN_XXL, new PacManXXL_MsPacMan_UIConfig());
