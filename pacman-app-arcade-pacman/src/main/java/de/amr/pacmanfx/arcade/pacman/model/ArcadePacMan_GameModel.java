...
public class ArcadePacMan_GameModel extends AbstractGameModel {
    ...
    protected void createAndSetGhosts(GameLevel level, House house) {
        ...
        level.setGhosts(
            ArcadePacMan_ActorFactory.createGhost(RED_GHOST_SHADOW,   terrain, house, WorldMapPropertyName.POS_GHOST_1_RED,    oneWayDownTiles),
            ArcadePacMan_ActorFactory.createGhost(PINK_GHOST_SPEEDY,  terrain, house, WorldMapPropertyName.POS_GHOST_2_PINK,   oneWayDownTiles),
            ArcadePacMan_ActorFactory.createGhost(CYAN_GHOST_BASHFUL, terrain, house, WorldMapPropertyName.POS_GHOST_3_CYAN,   oneWayDownTiles),
            ArcadePacMan_ActorFactory.createGhost(ORANGE_GHOST_POKEY, terrain, house, WorldMapPropertyName.POS_GHOST_4_ORANGE, oneWayDownTiles)
        );
    }
