        ...
        debugRenderer = adaptRenderer(new BaseDebugInfoRenderer(scene.ui(), canvas) {
            ...
            public void draw(GameScene2D scene) {
                ...
                if (scene instanceof ArcadePacMan_CutScene2 cutScene2) {
                    String text = cutScene2.frame() < ArcadePacMan_CutScene2.ANIMATION_START
                        ? String.format("Wait %d", ArcadePacMan_CutScene2.ANIMATION_START - cutScene2.frame())
                        : String.format("Frame %d", cutScene2.frame());
