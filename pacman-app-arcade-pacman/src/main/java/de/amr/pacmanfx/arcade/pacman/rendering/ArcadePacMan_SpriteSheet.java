...
public record ArcadePacMan_SpriteSheet(Image sourceImage) implements SpriteSheet<SpriteID> {
    ...
    static {
        SPRITE_MAP.addSprite(SpriteID.MAP_FULL, rect(0, 0, 224, 248));
        SPRITE_MAP.addSprite(SpriteID.MAP_EMPTY, rect(228, 0, 224, 248));
        SPRITE_MAP.addSpriteSequence(SpriteID.GHOST_NUMBERS,
            rect(456, 133, 15, 7),  // 200
            rect(472, 133, 15, 7),  // 400
            rect(488, 133, 15, 7),  // 800
            rect(504, 133, 16, 7)   // 1600
        );
        SPRITE_MAP.addSpriteSequence(SpriteID.BONUS_SYMBOLS, IntStream.range(0, 8)
            .mapToObj(i -> rect(OFF_X + R16 * (2 + i), 49, 14, 14))
            .toArray(RectShort[]::new));
        SPRITE_MAP.addSpriteSequence(SpriteID.BONUS_VALUES,
        ...
        SPRITE_MAP.addSprite(SpriteID.LIVES_COUNTER_SYMBOL,  rect(OFF_X + 129, 15, 16, 16));
        SPRITE_MAP.addSpriteSequence(SpriteID.PACMAN_MUNCHING_RIGHT, makePacManMunchingSpriteSeq(0));
        SPRITE_MAP.addSpriteSequence(SpriteID.PACMAN_MUNCHING_LEFT,  makePacManMunchingSpriteSeq(1));
