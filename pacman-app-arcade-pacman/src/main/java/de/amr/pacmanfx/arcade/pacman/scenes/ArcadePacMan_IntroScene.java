...
public class ArcadePacMan_IntroScene extends GameScene2D {
    ...
    public void doInit(Game game) {
        ...
        actionBindings.registerAllFrom(ArcadePacMan_UIConfig.GAME_START_ACTION_BINDINGS); // insert coin + start game actions
            ...
            public void onUpdate(ArcadePacMan_IntroScene scene) {
                ...
                if (timer.atSecond(0.75)) {
                    ...
                    if (!game.canStartNewGame()) {
                        game.control().enterState(Arcade_GameState.STARTING_GAME_OR_LEVEL);
                    }
                } else if (timer.atSecond(5)) {
                    game.control().enterState(Arcade_GameState.SETTING_OPTIONS_FOR_START);
                }
            }
        };
