...
public class ArcadePacMan_IntroScene extends GameScene2D {
    ...
    public void doInit(Game game) {
        ...
        pacMan.selectAnimation(CommonAnimationID.PAC_MUNCHING);
    ...
    public enum SceneState implements StateMachine.State<ArcadePacMan_IntroScene> {
        ...
        CHASING_PAC {
            ...
            public void onEnter(ArcadePacMan_IntroScene scene) {
                ...
                scene.pacMan.show();
                scene.pacMan.playAnimation(CommonAnimationID.PAC_MUNCHING);
            ...
            public void onUpdate(ArcadePacMan_IntroScene scene) {
                ...
                scene.ghosts.stream()
                    ...
                    .ifPresent(victim -> {
                        ...
                        victim.selectAnimationAt(CommonAnimationID.GHOST_POINTS, scene.victims.size() - 1);
                    });
