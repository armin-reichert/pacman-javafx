...
public class PacManXXL_App extends Application {
    ...
    public void init() {
        ...
        THE_GAME_CONTROLLER.defineGameModel(GameVariant.PACMAN_XXL, pacManGameModel);
        THE_GAME_CONTROLLER.defineGameModel(GameVariant.MS_PACMAN_XXL, msPacManGameModel);
