...
public class ArcadePacManXXL_PacMan_GameConfig3D extends ArcadePacManXXL_PacMan_GameConfig
        implements GameConfiguration3D {

    public ArcadePacManXXL_PacMan_GameConfig3D(AssetStorage assets) {
        super(assets);
