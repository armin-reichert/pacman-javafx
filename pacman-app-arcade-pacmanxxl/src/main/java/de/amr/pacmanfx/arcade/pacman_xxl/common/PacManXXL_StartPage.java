...
public class PacManXXL_StartPage implements StartPage {
    ...
    public void onEnter() {
        ...
        switch (selectedGameVariantID) {
            case ARCADE_PACMAN_XXL, ARCADE_MS_PACMAN_XXL -> game.variantManager().selectVariant(selectedGameVariantID.name());
    ...
    private void pauseProgressTimer() {
        game.ui().viewManager().assertView(GameViewID.START_PAGES, StartPagesView.class).rootPane().pauseProgress();
    }
