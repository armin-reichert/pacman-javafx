...
public class EditorUI {
    ...
    private TerrainMapColorScheme currentColorScheme(WorldMap worldMap) {
        return new TerrainMapColorScheme(
                ...
                EditorUtil.getColorFromMap(worldMap, LayerID.TERRAIN, WorldMapProperty.COLOR_WALL_FILL, MS_PACMAN_COLOR_WALL_FILL),
                EditorUtil.getColorFromMap(worldMap, LayerID.TERRAIN, WorldMapProperty.COLOR_WALL_STROKE, MS_PACMAN_COLOR_WALL_STROKE),
                EditorUtil.getColorFromMap(worldMap, LayerID.TERRAIN, WorldMapProperty.COLOR_DOOR, MS_PACMAN_COLOR_DOOR)
        );
    }
