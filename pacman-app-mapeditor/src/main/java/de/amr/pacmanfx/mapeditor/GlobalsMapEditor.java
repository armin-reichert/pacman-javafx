...
public final class GlobalsMapEditor {

    private GlobalsMapEditor() {}
    ...
    public static final String SAMPLE_MAPS_ROOT = "/de/amr/pacmanfx/mapeditor/maps/";

    public static final String SAMPLE_MAP_PATH_PACMAN    = SAMPLE_MAPS_ROOT + "pacman/pacman.world";
    public static final String SAMPLE_MAP_PATH_MS_PACMAN = SAMPLE_MAPS_ROOT + "mspacman/mspacman_%d.world";
    public static final String SAMPLE_MAP_PATH_MASONIC   = SAMPLE_MAPS_ROOT + "pacman_xxl/masonic_%d.world";
