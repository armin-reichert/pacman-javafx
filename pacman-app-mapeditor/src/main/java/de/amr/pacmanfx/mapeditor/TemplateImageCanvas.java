...
public class TemplateImageCanvas extends Canvas {
    ...
    private void showColorSelectionContextMenu(TileMapEditor editor, ContextMenuEvent e) {
        ...
        Color fillColor = getColorFromMapLayer(worldMap().terrainLayer(), WorldMapPropertyName.COLOR_WALL_FILL, null);
        ...
        miPickFillColor.setOnAction(ae -> new Action_SetTerrainProperty(editor,
            WorldMapPropertyName.COLOR_WALL_FILL, formatRGBA(colorToSelect)).execute());

        Color strokeColor = getColorFromMapLayer(worldMap().terrainLayer(), WorldMapPropertyName.COLOR_WALL_STROKE, null);
        ...
        miPickStrokeColor.setOnAction(ae -> new Action_SetTerrainProperty(editor,
            WorldMapPropertyName.COLOR_WALL_STROKE, formatRGBA(colorToSelect)).execute());

        Color doorColor = getColorFromMapLayer(worldMap().terrainLayer(), WorldMapPropertyName.COLOR_DOOR, null);
        ...
        miPickDoorColor.setOnAction(ae -> new Action_SetTerrainProperty(editor,
            WorldMapPropertyName.COLOR_DOOR, formatRGBA(colorToSelect)).execute());
        ...
        miPickFoodColor.setOnAction(ae -> new Action_SetFoodProperty(editor,
            WorldMapPropertyName.COLOR_FOOD, formatRGBA(colorToSelect)).execute());
