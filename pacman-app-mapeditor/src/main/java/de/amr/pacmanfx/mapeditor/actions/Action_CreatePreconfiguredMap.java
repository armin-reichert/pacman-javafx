...
public class Action_CreatePreconfiguredMap extends EditorAction<WorldMap> {
    ...
    public WorldMap execute() {
        ...
        if (newMap.numRows() >= 20) {
            ...
            newMap.properties(LayerID.TERRAIN).put(DefaultWorldMapPropertyName.POS_PAC,   String.valueOf(houseMinTile.plus(3, 11)));
            newMap.properties(LayerID.TERRAIN).put(DefaultWorldMapPropertyName.POS_BONUS, String.valueOf(houseMinTile.plus(3, 5)));
        }
