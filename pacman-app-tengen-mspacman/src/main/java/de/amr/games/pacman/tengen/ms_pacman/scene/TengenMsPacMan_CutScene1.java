 ...
 * the screen and aButtonKey big pink heart appears above them. (Played after round 2)
 *
...
public class TengenMsPacMan_CutScene1 extends GameScene2D {
    ...
    public void bindGameActions() {
        bind(THE_GAME_CONTROLLER::terminateCurrentState, THE_UI.keyboard().selectedJoypad().key(NES_JoypadButton.BUTTON_START));
    }
