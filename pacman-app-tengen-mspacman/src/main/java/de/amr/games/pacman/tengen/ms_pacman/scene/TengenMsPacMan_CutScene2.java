...
import static de.amr.games.pacman.tengen.ms_pacman.TengenMsPacMan_GameConfig3D.NES_TILES;
...
public class TengenMsPacMan_CutScene2 extends GameScene2D {
    ...
    public void bindGameActions() {
        bind(context -> context.gameController().terminateCurrentState(), context.currentJoypadKeyBinding().key(NES_JoypadButton.BTN_START));
    }
