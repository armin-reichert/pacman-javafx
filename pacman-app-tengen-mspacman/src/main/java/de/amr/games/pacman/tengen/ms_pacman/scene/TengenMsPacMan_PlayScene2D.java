...
import static de.amr.games.pacman.tengen.ms_pacman.TengenMsPacMan_GameConfig.*;
...
public class TengenMsPacMan_PlayScene2D extends GameScene2D implements CameraControlledView {
    ...
    protected void drawSceneContent() {
        ...
        if (flashing && levelCompleteAnimation.isInHighlightPhase()) {
            ...
            r.drawFood(world);
            r.drawLevelMessage(context.gameConfiguration().assetKeyPrefix(), level, game.isDemoLevel());
        }
