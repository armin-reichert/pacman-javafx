...
public record TengenMsPacMan_SpriteSheet(Image sourceImage) implements SpriteSheet<SpriteID> {
    ...
    static {
        ...
        SPRITE_MAP.put(MR_PAC_WAVING_HAND,  new Sprite[] {makeSprite(140, 36, 20, 20), makeSprite(163, 36, 20, 20),});
        SPRITE_MAP.put(MR_PAC_TURNING_AWAY, new Sprite[] {makeSprite(186, 42, 15, 15), makeSprite(205, 46, 8, 8), makeSprite(218, 47, 5, 5),});
        SPRITE_MAP.put(RED_GHOST_RIGHT,     new Sprite[] {makeSprite(10, 120, 14, 13), makeSprite(26, 120, 14, 13),});
        SPRITE_MAP.put(RED_GHOST_LEFT,      new Sprite[] {makeSprite(42, 120, 14, 13), makeSprite(58, 120, 14, 13)});
        SPRITE_MAP.put(RED_GHOST_UP,        new Sprite[] {makeSprite(74, 120, 14, 13), makeSprite(90, 120, 14, 13)});
        SPRITE_MAP.put(RED_GHOST_DOWN,      new Sprite[] {makeSprite(106, 120, 14, 13), makeSprite(122, 120, 14, 13)});
        SPRITE_MAP.put(PINK_GHOST_RIGHT,    new Sprite[] {makeSprite(10, 135, 14, 13), makeSprite(26, 135, 14, 13)});
        SPRITE_MAP.put(PINK_GHOST_LEFT,     new Sprite[] {makeSprite(42, 135, 14, 13), makeSprite(58, 135, 14, 13)});
        SPRITE_MAP.put(PINK_GHOST_UP,       new Sprite[] {makeSprite(74, 135, 14, 13), makeSprite(90, 135, 14, 13)});
        SPRITE_MAP.put(PINK_GHOST_DOWN,     new Sprite[] {makeSprite(106, 135, 14, 13), makeSprite(122, 135, 14, 13)});
        SPRITE_MAP.put(CYAN_GHOST_RIGHT,    new Sprite[] {makeSprite(10, 150, 14, 13), makeSprite(26, 150, 14, 13)});
        SPRITE_MAP.put(CYAN_GHOST_LEFT,     new Sprite[] {makeSprite(42, 150, 14, 13), makeSprite(58, 150, 14, 13)});
        SPRITE_MAP.put(CYAN_GHOST_UP,       new Sprite[] {makeSprite(74, 150, 14, 13), makeSprite(90, 150, 14, 13)});
        SPRITE_MAP.put(CYAN_GHOST_DOWN,     new Sprite[] {makeSprite(106, 150, 14, 13), makeSprite(122, 150, 14, 13)});
        SPRITE_MAP.put(ORANGE_GHOST_RIGHT,  new Sprite[] {makeSprite(10, 165, 14, 13), makeSprite(26, 165, 14, 13)});
        SPRITE_MAP.put(ORANGE_GHOST_LEFT,   new Sprite[] {makeSprite(42, 165, 14, 13), makeSprite(58, 165, 14, 13)});
        SPRITE_MAP.put(ORANGE_GHOST_UP,     new Sprite[] {makeSprite(74, 165, 14, 13), makeSprite(90, 165, 14, 13)});
        SPRITE_MAP.put(ORANGE_GHOST_DOWN,   new Sprite[] {makeSprite(106, 165, 14, 13), makeSprite(122, 165, 14, 13)});
        SPRITE_MAP.put(GHOST_FRIGHTENED,    new Sprite[] {makeSprite(138, 120, 14, 13), makeSprite(154, 120, 14, 13)});
        ...
        SPRITE_MAP.put(CLAPPERBOARD, new Sprite[] {
            ...
            makeSprite(91, 361, 32, 32), makeSprite(53, 361, 32, 32), makeSprite(14, 361, 32, 32),
        });
        SPRITE_MAP.put(STORK, new Sprite[] {makeSprite(157, 355, 33, 16), makeSprite(198, 355, 33, 16)});
    }
