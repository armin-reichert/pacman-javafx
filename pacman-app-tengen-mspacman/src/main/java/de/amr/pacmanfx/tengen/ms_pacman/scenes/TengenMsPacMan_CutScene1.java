...
public class TengenMsPacMan_CutScene1 extends GameScene2D {
    ...
    public void draw() {
        ...
        if (game.mapCategory() != MapCategory.ARCADE) {
            gameRenderer.drawHUD(gameContext(), game.hud(), sizeInPx().minus(0, 2 * TS), ui.theGameClock().tickCount());
        }
    }
    ...
    public void drawSceneContent() {
        ...
        gr().drawActors(List.of(clapperboard, msPacMan, pacMan, inky, pinky, heart));
    }
}