...
import de.amr.pacmanfx.core.entities.hud.levelCounter.LevelCounterBehavior;
...
import de.amr.pacmanfx.core.entities.props.messageview.MessageViewStyleComp;
...
public class TengenMsPacMan_GamePlay extends CommonGamePlay {
    ...
    public void startSession(GameContext game) {
        ...
        session.setNumLives(game.playConfig().initialLifeCount());
        ...
        game.playConfig().gameFlow().restartGameState(game, CommonGameStateID.BOOT);
    }
    ...
    public GameLevel createLevel(GameContext game, int levelNumber) {
        ...
        configurePacAndGhosts(entities, game.playConfig().systems(), worldMap.terrainLayer());
    ...
    public void startLevel(GameContext game, GameLevel level) {
        ...
        final LevelCounterSystem levelCounterSystem = game.playConfig().systems().levelCounterSystem();
