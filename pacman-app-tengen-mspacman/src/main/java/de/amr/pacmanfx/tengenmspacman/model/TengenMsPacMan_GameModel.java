...
public class TengenMsPacMan_GameModel extends AbstractGameModel {
    ...
    private class TengenMsPacMan_SpeedControl implements ActorSpeedControl {
    ...
    public TengenMsPacMan_GameModel(File highScoreFile) {
        ...
        actorSpeedControl = new TengenMsPacMan_SpeedControl();
    ...
    public void doPacManDying(Pac pac, long tick) {
        ...
        if (tick == 1) {
            ...
            pac.selectAnimation(Pac.AnimationID.PAC_DYING);
            pac.resetAnimation();
        }
