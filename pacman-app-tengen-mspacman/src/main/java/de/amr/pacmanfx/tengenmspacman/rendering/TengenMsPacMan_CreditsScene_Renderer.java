...
public class TengenMsPacMan_CreditsScene_Renderer extends GameScene2D_Renderer implements TengenMsPacMan_SceneRenderingCommons {
    ...
    public TengenMsPacMan_CreditsScene_Renderer(GameScene2D scene, Canvas canvas, PreferencesManager prefs) {
        super(canvas);
    ...
    public void draw(GameScene2D scene) {
        ...
        if (scene.gameContext().currentGameState().timer().betweenSeconds(0, 0.5 * DISPLAY_SECONDS)) {
