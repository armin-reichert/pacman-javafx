...
public class TengenMsPacMan_OptionsScene_Renderer extends GameScene2D_Renderer
    ...
    public TengenMsPacMan_OptionsScene_Renderer(PreferencesManager prefs, GameScene2D scene, Canvas canvas) {
        super(canvas);
    ...
    public void draw(GameScene2D scene) {
        ...
        drawHorizontalBar(nesColor(0x20), nesColor(0x21), optionsScene.unscaledSize().x(), TS, 20);
        ...
        drawHorizontalBar(nesColor(0x20), nesColor(0x21), optionsScene.unscaledSize().x(), TS, 212);
