    ...
    implements GameScene2D_Renderer, SpriteRendererMixin, TengenMsPacMan_SceneRendererMixin
{
    ...
    public void draw(GameScene2D scene) {
        ...
        drawHorizontalBar(nesColor(0x20), nesColor(0x21), optionsScene.unscaledSceneSize().x(), TS, 20);
        ...
        drawHorizontalBar(nesColor(0x20), nesColor(0x21), optionsScene.unscaledSceneSize().x(), TS, 212);
