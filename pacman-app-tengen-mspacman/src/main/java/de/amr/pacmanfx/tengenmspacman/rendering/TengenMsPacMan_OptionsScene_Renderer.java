    ...
    implements GameScene2D_Renderer, SpriteRenderer, TengenMsPacMan_SceneRendererMixin
{
    ...
    public void draw(GameScene gameScene, long tick) {
        ...
        drawHorizontalBar(NES_Palette.color(0x20), NES_Palette.color(0x21), scene.canvasRendering().unscaledWidth(), TS, 20);
        ...
        drawHorizontalBar(NES_Palette.color(0x20), NES_Palette.color(0x21), scene.canvasRendering().unscaledWidth(), TS, 212);
