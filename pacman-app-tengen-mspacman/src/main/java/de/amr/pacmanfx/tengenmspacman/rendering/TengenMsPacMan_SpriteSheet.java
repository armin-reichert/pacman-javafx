...
public final class TengenMsPacMan_SpriteSheet implements SpriteSheet<SpriteID> {
    ...
    private TengenMsPacMan_SpriteSheet() {
        ...
        spriteMap.add(INFO_CATEGORY_BIG,     rect(261, 141, 26, 7));
        spriteMap.add(INFO_CATEGORY_MINI,    rect(261, 149, 26, 7));
        spriteMap.add(INFO_CATEGORY_STRANGE, rect(261, 133, 26, 7));
        spriteMap.add(INFO_DIFFICULTY_CRAZY, rect(229, 133, 18, 7));
        spriteMap.add(INFO_DIFFICULTY_EASY,  rect(229, 149, 18, 7));
        spriteMap.add(INFO_DIFFICULTY_HARD,  rect(229, 141, 18, 7));
        spriteMap.add(HEART,                 rect(162, 270, 18, 18));
        spriteMap.add(BLUE_BAG,              rect(241, 363, 7, 8));
        spriteMap.add(JUNIOR_PAC,            rect(176, 304, 7, 8));
        spriteMap.add(GHOST_EYES_RIGHT,      rect(140, 173, 10, 5));
        spriteMap.add(GHOST_EYES_LEFT,       rect(140, 166, 10, 5));
        spriteMap.add(GHOST_EYES_UP,         rect(153, 166, 10, 5));
        spriteMap.add(GHOST_EYES_DOWN,       rect(153, 173, 10, 5));
        spriteMap.add(CONTINUES_0,           rect(180, 243, 40, 8));
        spriteMap.add(CONTINUES_1,           rect(180, 234, 40, 8));
        spriteMap.add(CONTINUES_2,           rect(180, 225, 40, 8));
        spriteMap.add(CONTINUES_3,           rect(180, 216, 40, 8));
        spriteMap.add(LEVEL_NUMBER_BOX,      rect(200, 164, 16, 16));
        spriteMap.add(LIVES_COUNTER_SYMBOL,  rect(241, 15, 16, 16));
        spriteMap.add(DIGIT_1,               rect(185 + 5,      184, 4, 5));
        spriteMap.add(DIGIT_2,               rect(185 + 5 *  2, 184, 4, 5));
        spriteMap.add(DIGIT_3,               rect(185 + 5 *  3, 184, 4, 5));
        spriteMap.add(DIGIT_4,               rect(185 + 5 *  4, 184, 4, 5));
        spriteMap.add(DIGIT_5,               rect(185 + 5 *  5, 184, 4, 5));
        spriteMap.add(DIGIT_6,               rect(185 + 5 *  6, 184, 4, 5));
        spriteMap.add(DIGIT_7,               rect(185 + 5 *  7, 184, 4, 5));
        spriteMap.add(DIGIT_8,               rect(185 + 5 *  8, 184, 4, 5));
        spriteMap.add(DIGIT_9,               rect(185 + 5 *  9, 184, 4, 5));
        spriteMap.add(DIGIT_0,               rect(185 + 5 * 10, 184, 4, 5));
        spriteMap.add(MS_PAC_FULL,           rect(32, 15, 15, 15));
