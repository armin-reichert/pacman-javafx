...
import static de.amr.pacmanfx.tengenmspacman.TengenMsPacManConfig.*;
...
public class TengenMsPacMan_BootScene extends GameScene2D {
    ...
    public TengenMsPacMan_BootScene(Game game) {
        super(game);
    ...
    public void onActivate() {
        ...
        ghost = game().currentVariantConfig().createAnimatedGhost(game().ui().sprites().animations(), GameModel.RED_GHOST_SHADOW);
    }
