...
public class TengenMsPacMan_CutScene2 extends GameScene2D {
    ...
    public void onActivate(UIConfig uiConfig) {
        ...
        ui.facade().sounds().play(PacManGameSoundID.INTERMISSION_2);
    }

    @Override
    public void onDeactivate() {
        ui.facade().sounds().stop(PacManGameSoundID.INTERMISSION_2);
    }

    @Override
    public void onTick(GameClock clock) {
        final State<Game> gameState = services().currentGame().flow().state();
