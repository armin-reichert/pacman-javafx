    ...
    public enum SceneState implements State<TengenMsPacMan_IntroScene> {
        ...
        SHOWING_MARQUEE {
            ...
            public void onEnter(TengenMsPacMan_IntroScene scene) {
                ...
                final SpriteAnimationSet spriteAnimationSet = scene.appContext().ui().sprites().animationSet();
        ...
        MS_PACMAN_MARCHING_IN {
            ...
            public void onUpdate(TengenMsPacMan_IntroScene scene) {
                ...
                if (timer.atSecond(8)) {
                    ...
                    final TengenMsPacMan_GameModel gameModel = (TengenMsPacMan_GameModel) scene.gameContext().model();
