    ...
    public enum SceneState implements State<TengenMsPacMan_IntroScene> {
        ...
        GHOSTS_MARCHING_IN {
            ...
            boolean letGhostMarchIn(TengenMsPacMan_IntroScene scene) {
                ...
                Logger.debug("Tick {}: {} marching in", scene.facade().gameContext().clock().tickCount(), ghost.name());
        ...
        MS_PACMAN_MARCHING_IN {
            ...
            public void onUpdate(TengenMsPacMan_IntroScene scene) {
                scene.marquee.update(timer.tickCount());
                Logger.debug("Tick {}: {} marching in", scene.facade().gameContext().clock().tickCount(), scene.msPacMan.name());
                scene.msPacMan.move();
                ...
                if (timer.atSecond(8)) {
                    ...
                    TengenMsPacMan_GameModel game = scene.facade().currentGame();
