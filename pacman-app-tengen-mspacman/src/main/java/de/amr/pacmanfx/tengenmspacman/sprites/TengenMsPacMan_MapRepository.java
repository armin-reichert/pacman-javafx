...
public class TengenMsPacMan_MapRepository {
    ...
    public MapImageSet createMapImageSet(WorldMap worldMap, int flashCount) {
        ...
        final boolean randomFlashColors = worldMap.getConfigValue(TengenMsPacMan_GameLevelRendererKey.MULTIPLE_FLASH_COLORS);
        ...
        return switch (mapCategory) {
            ...
            case STRANGE -> strangeMapImageSet(
                worldMap.getConfigValue(TengenMsPacMan_GameLevelRendererKey.MAP_ID), // set by map selector!
    ...
    private MapImageSet strangeMapImageSet(
        ...
        final RectShort mazeSprite = NonArcadeMapsSpriteSheet.instance().findSprite(mapID);
