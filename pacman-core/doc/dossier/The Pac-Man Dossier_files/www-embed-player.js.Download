...
c.prototype=b.prototype;a.X=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.ur=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
l=pe.prototype;l.Dc=function(a){var b=Ka.apply(1,arguments),c=this.tb(b);c?c.push(new oe(a)):this.pc(a,b)};
l.pc=function(a){this.za.set(this.Yb(Ka.apply(1,arguments)),[new oe(a)])};
l.tb=function(){var a=this.Yb(Ka.apply(0,arguments));return this.za.has(a)?this.za.get(a):void 0};
l.Pc=function(){var a=this.tb(Ka.apply(0,arguments));return a&&a.length?a[0]:void 0};
l.clear=function(){this.za.clear()};
l.Yb=function(){var a=Ka.apply(0,arguments);return a?a.join(","):"key"};function qe(a,b){pe.call(this,a,3,b)}
...
l.yd=function(a){this.h=0;Bf(this,2,a)};
l.zd=function(a){this.h=0;Bf(this,3,a)};
...
l.Nc=function(){for(var a;a=Jf(this);)Kf(this,a,this.h,this.v);this.o=!1};
...
l.wd=function(){if(this.enabled){var a=Date.now()-this.o;0<a&&a<.8*this.j?this.Z=this.i.setTimeout(this.m,this.j-a):(this.Z&&(this.i.clearTimeout(this.Z),this.Z=null),ef(this,"tick"),this.enabled&&(this.stop(),this.start()))}};
...
l.Ob=function(a){var b=Ka.apply(1,arguments);this.h.has(a)||this.h.set(a,new qe(a,b))};
...
l.Va=function(a){this.yc.apply(this,[a,1].concat(ja(Ka.apply(1,arguments))))};
l.yc=function(a,b){var c=Ka.apply(2,arguments),d=Xf(this,a);d&&d instanceof qe&&(d.j(b,c),Vf(this))};
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,q;a();return{reset:a,update:c,digest:d,Kc:function(){for(var r=d(),w="",t=0;t<r.length;t++)w+="0123456789ABCDEF".charAt(Math.floor(r[t]/16))+"0123456789ABCDEF".charAt(r[t]%16);return w}}}
...
l.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Mr;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.hb}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);c=f?";domain="+f:"";g=g?";path="+g:"";d=d?";secure":"";h=0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString();this.h.cookie=a+"="+b+c+g+h+d+(null!=e?";samesite="+
e:"")};
...
l.wb=function(){return sg(this).keys};
...
l=Mg.prototype;l.Ic=function(){this.dispose();lb(Pg,this)};
...
l.tc=function(){"undefined"!=typeof Na&&this.A&&(this.m="Timed out after "+this.o+"ms, aborting",this.getStatus(),ef(this,"timeout"),this.abort(8))};
function Rg(a,b){a.i=!1;a.A&&(a.j=!0,a.A.abort(),a.j=!1);a.m=b;Ug(a);Vg(a)}
function Ug(a){a.O||(a.O=!0,ef(a,"complete"),ef(a,"error"))}
l.abort=function(){this.A&&this.i&&(this.getStatus(),this.i=!1,this.j=!0,this.A.abort(),this.j=!1,ef(this,"complete"),ef(this,"abort"),Vg(this))};
l.B=function(){this.A&&(this.i&&(this.i=!1,this.j=!0,this.A.abort(),this.j=!1),Vg(this,!0));Mg.X.B.call(this)};
l.hc=function(){this.h()||(this.P||this.s||this.j?Yg(this):this.Zc())};
l.Zc=function(){Yg(this)};
...
u(lh,H);var mh;mh=new function(a,b,c){this.i=a;this.fieldName=b;this.h=c;this.isRepeated=0;this.j=ne}(175237375,{Cr:0},lh);function nh(a,b,c,d,e,f,g,h,k,m,q){df.call(this);var r=this;this.O="";this.j=[];this.Mb="";this.Nb=this.sa=-1;this.Xa=!1;this.I=this.m=null;this.F=0;this.Bc=1;this.timeoutMillis=0;this.ba=!1;df.call(this);this.Ya=b||function(){};
this.s=new oh(a,f);this.zc=d;this.Wa=q;this.Cc=Za(jf,0,1);this.T=e||null;this.K=c||null;this.V=g||!1;this.pageId=k||null;this.logger=null;this.withCredentials=!h;this.Ga=f||!1;!this.Ga&&(65<=ac("Chromium")||45<=ac("Firefox")||12<=ac("Safari")||(Fc()||C("iPad")||C("iPod"))&&Gc());a=D(new eh,1,1);ph(this.s,a);this.o=new Ag(1E4);this.i=new Rf(this.o.getValue());ue(this,this.i);m=qh(this,m);Te(this.i,"tick",m,!1,this);this.P=new Rf(6E5);ue(this,this.P);Te(this.P,"tick",m,!1,this);this.V||this.P.start();
...
k;this.I&&this.I.isSupported(h.length)&&(k=this.I.compress(h));var m={url:g,body:h,Gc:1,Gb:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(t){c.o.reset();Sf(c.i,c.o.getValue());if(t){var A=null;try{var E=JSON.parse(t.replace(")]}'\n",""));A=new jh(E)}catch(F){}A&&(t=Number(ee(Rd(A,1),"-1")),0<t&&(c.sa=Date.now(),c.Nb=c.sa+t),A=mh.j(A))&&(A=ee(Rd(A,1),-1),-1!=A&&(c.Xa||sh(c,A)))}a&&a()},r=function(t,A){var E=$d(e,fh,3),F=c.o;
...
k?k.then(function(t){m.Gb["Content-Encoding"]="gzip";m.Gb["Content-Type"]="application/binary";m.body=t;m.Gc=2;w()},function(){w()}):w()}}}};
...
l=xi.prototype;l.wb=function(){yi(this);return this.h.concat()};
...
l.forEach=function(a,b){for(var c=this.wb(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
...
null==(r=Gh.screen)?void 0:r.availWidth;var w;e.u_cd=null==(w=Gh.screen)?void 0:w.colorDepth}catch(ea){}h=b.h;try{var t=h.screenX;var A=h.screenY}catch(ea){}try{var E=h.outerWidth;var F=h.outerHeight}catch(ea){}try{var O=h.innerWidth;var N=h.innerHeight}catch(ea){}try{var Q=h.screenLeft;var ca=h.screenTop}catch(ea){}try{O=h.innerWidth,N=h.innerHeight}catch(ea){}try{var U=h.screen.availWidth;var sb=h.screen.availTop}catch(ea){}t=[Q,ca,t,A,U,sb,E,F,O,N];try{var Wa=(b.h.top||window).document,oa="CSS1Compat"==
...
return b}
function Bl(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&al(b)(k)}
...
l=fn.prototype;l.add=function(a,b,c){return gn(this,[a],{mode:"readwrite",R:!0},function(d){return d.objectStore(a).add(b,c)})};
l.clear=function(a){return gn(this,[a],{mode:"readwrite",R:!0},function(b){return b.objectStore(a).clear()})};
l.close=function(){this.h.close();var a;(null==(a=this.options)?0:a.closed)&&this.options.closed()};
l.count=function(a,b){return gn(this,[a],{mode:"readonly",R:!0},function(c){return c.objectStore(a).count(b)})};
function hn(a,b,c){a=a.h.createObjectStore(b,c);return new jn(a)}
l.delete=function(a,b){return gn(this,[a],{mode:"readwrite",R:!0},function(c){return c.objectStore(a).delete(b)})};
l.get=function(a,b){return gn(this,[a],{mode:"readonly",R:!0},function(c){return c.objectStore(a).get(b)})};
...
l=jn.prototype;l.add=function(a,b){return cn(this.h.add(a,b))};
l.autoIncrement=function(){return this.h.autoIncrement};
l.clear=function(){return cn(this.h.clear()).then(function(){})};
function pn(a,b,c){a.h.createIndex(b,c,{unique:!1})}
l.count=function(a){return cn(this.h.count(a))};
function qn(a,b){return rn(a,{query:b},function(c){return c.delete().then(function(){return c.continue()})}).then(function(){})}
l.delete=function(a){return a instanceof IDBKeyRange?qn(this,a):cn(this.h.delete(a))};
l.get=function(a){return cn(this.h.get(a))};
l.index=function(a){try{return new sn(this.h.index(a))}catch(b){if(b instanceof Error&&"NotFoundError"===b.name)throw new Qm(a,this.h.name);throw b;}};
l.getName=function(){return this.h.name};
...
b.h.addEventListener("abort",function(){var e=b.h.error;if(e)d(e);else if(!b.i){e=Om;for(var f=b.h.objectStoreNames,g=[],h=0;h<f.length;h++){var k=f.item(h);if(null===k)throw Error("Invariant: item in DOMStringList is null");g.push(k)}e=new e("UNKNOWN_ABORT",{objectStoreNames:g.join(),dbName:b.h.db.name,mode:b.h.mode});d(e)}})})}
...
l=sn.prototype;l.count=function(a){return cn(this.h.count(a))};
l.delete=function(a){return un(this,{query:a},function(b){return b.delete().then(function(){return b.continue()})})};
l.get=function(a){return cn(this.h.get(a))};
l.getKey=function(a){return cn(this.h.getKey(a))};
l.keyPath=function(){return this.h.keyPath};
...
l=vn.prototype;l.advance=function(a){this.cursor.advance(a);return tn(this.request)};
l.continue=function(a){this.cursor.continue(a);return tn(this.request)};
l.delete=function(){return cn(this.cursor.delete()).then(function(){})};
l.getKey=function(){return this.cursor.key};
l.getValue=function(){return this.cursor.value};
l.update=function(a){return cn(this.cursor.update(a))};function wn(a,b,c){return new Promise(function(d,e){function f(){w||(w=new fn(g.result,{closed:r}));return w}
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.Fc,k=c.blocking,m=c.vd,q=c.upgrade,r=c.closed,w;g.addEventListener("upgradeneeded",function(t){try{if(null===t.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");t.dataLoss&&"none"!==t.dataLoss&&Fm("IDB_DATA_CORRUPTED",{reason:t.dataLossMessage||"unknown reason",dbName:Hm(a)});var A=f(),E=new ln(g.transaction);
...
function Dn(a){function b(){var f,g,h,k,m,q,r,w,t,A;return x(function(E){switch(E.h){case 1:return g=null!=(f=Error().stack)?f:"",za(E,2),v(E,a.j(a.name,a.options.version,d),4);case 4:h=E.i;for(var F=a.options,O=[],N=p(Object.keys(F.Ca)),Q=N.next();!Q.done;Q=N.next()){Q=Q.value;var ca=F.Ca[Q],U=void 0===ca.fd?Number.MAX_VALUE:ca.fd;!(h.h.version>=ca.Ha)||h.h.version>=U||h.h.objectStoreNames.contains(Q)||O.push(Q)}k=O;if(0===k.length){E.u(5);break}m=Object.keys(a.options.Ca);q=h.objectStoreNames();
...
function Vn(a,b,c,d){var e,f,g,h,k,m;return x(function(q){switch(q.h){case 1:return f=null!=(e=Error().stack)?e:"",v(q,Qn(),2);case 2:g=q.i;if(!g)throw h=Tm("openDbImpl",a,b),M("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),Em(h),h;Gm(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:Un(a);za(q,3);return v(q,Fn(k,g),5);case 5:return v(q,xn(k.actualName,b,d),6);case 6:return q.return(q.i);case 3:return m=Ba(q),za(q,7),v(q,Gn(k.actualName,g),9);case 9:Aa(q,
...
;function mo(){}
function no(a,b,c){var d,e,f,g;return x(function(h){if(1==h.h){if(!M("gcf_config_store_update_enabled"))return h.u(0);c&&(a.h=c,z("yt.gcf.config.hotConfigGroup",a.h));a.hotHashData=b;z("yt.gcf.config.hotHashData",a.hotHashData);d=Pn();return d?c?h.u(4):v(h,lo(d),5):(e=Tm("updateHotConfig token error"),cl(e),h.u(0))}4!=h.h&&(f=h.i,c=null==(g=f)?void 0:g.config);return v(h,io(c,b,d),0)})}
function oo(a,b,c){var d,e,f,g,h;return x(function(k){if(1==k.h){if(!M("gcf_config_store_update_enabled"))return k.u(0);a.coldHashData=b;z("yt.gcf.config.coldHashData",a.coldHashData);d=Pn();return d?c?k.u(4):v(k,ko(d),5):(e=Tm("updateColdConfig token error"),cl(e),k.u(0))}4!=k.h&&(f=k.i,c=null==(g=f)?void 0:g.config);if(!c)return k.u(0);h=c.configData;return v(k,jo(c,b,h,d),0)})}
...
function zo(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.tr||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().sr:b=xg([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
this.Ba=function(){};
this.now=Date.now;this.Ia=!1;var b;this.sc=null!=(b=a.sc)?b:100;var c;this.nc=null!=(c=a.nc)?c:1;var d;this.lc=null!=(d=a.lc)?d:2592E6;var e;this.jc=null!=(e=a.jc)?e:12E4;var f;this.mc=null!=(f=a.mc)?f:5E3;var g;this.H=null!=(g=a.H)?g:void 0;this.fb=!!a.fb;var h;this.eb=null!=(h=a.eb)?h:.1;var k;this.kb=null!=(k=a.kb)?k:10;a.handleError&&(this.handleError=a.handleError);a.Ba&&(this.Ba=a.Ba);a.Ia&&(this.Ia=a.Ia);a.ab&&(this.ab=a.ab);this.J=a.J;this.Y=a.Y;this.N=a.N;this.L=a.L;this.ia=a.ia;this.Db=
...
l=Ho.prototype;l.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(Io(this)&&this.h){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.N.set(d,this.H).then(function(e){d.id=e;c.L.U()&&Lo(c,d)}).catch(function(e){Lo(c,d);
Mo(c,e)})}else this.ia(a,b)};
l.sendThenWrite=function(a,b,c){var d=this;b=void 0===b?{}:b;if(Io(this)&&this.h){var e={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.J&&this.J("nwl_skip_retry")&&(e.skipRetry=c);if(this.L.U()||this.J&&this.J("nwl_aggressive_send_then_write")&&!e.skipRetry){if(!e.skipRetry){var f=b.onError?b.onError:function(){};
b.onError=function(g,h){return x(function(k){if(1==k.h)return v(k,d.N.set(e,d.H).catch(function(m){Mo(d,m)}),2);
...
l.sendAndWrite=function(a,b){var c=this;b=void 0===b?{}:b;if(Io(this)&&this.h){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0},e=!1,f=b.onSuccess?b.onSuccess:function(){};
...
l.Pa=function(){var a=this;if(!Io(this))throw Tm("throttleSend");this.i||(this.i=this.Y.S(function(){var b;return x(function(c){if(1==c.h)return v(c,a.N.Zb("NEW",a.H),2);if(3!=c.h)return b=c.i,b?v(c,Lo(a,b),3):(a.Qb(),c.return());a.i&&(a.i=0,a.Pa());c.h=0})},this.sc))};
l.Qb=function(){this.Y.da(this.i);this.i=0};
...
b.options.onError=function(e,f){var g,h,k;return x(function(m){switch(m.h){case 1:g=Po(f);if(!(a.J&&a.J("nwl_consider_error_code")&&g||a.J&&!a.J("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.kb)){m.u(2);break}if(!a.L.nb){m.u(3);break}return v(m,a.L.nb(),3);case 3:if(a.L.U()){m.u(2);break}c(e,f);if(!a.J||!a.J("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return v(m,a.N.Hb(b.id,a.H,!1),6);case 6:return m.return();case 2:if(a.J&&a.J("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.kb)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.u(8);break}return b.sendCount<a.nc?v(m,a.N.Hb(b.id,a.H),12):v(m,a.N.Aa(b.id,a.H),8);case 12:a.Y.S(function(){a.L.U()&&a.Pa()},a.mc);
case 8:c(e,f),m.h=0}})};
...
function hp(a,b){var c,d,e,f,g,h,k;return x(function(m){if(1==m.h)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},v(m,ep(b),2);if(3!=m.h)return d=m.i,e=L("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,R()],h=IDBKeyRange.bound(f,g),k=void 0,v(m,gn(d,["LogsRequestsStore"],{mode:"readwrite",R:!0},function(q){return un(q.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(r){r.getValue()&&(k=r.getValue(),"NEW"===a&&(k.status="QUEUED",
r.update(k)))})}),3);
c.xd=R();gp(c);return m.return(k)})}
...
l=kq.prototype;l.U=function(){return this.i.U()};
l.va=function(a){this.i.i=a};
l.Qc=function(){var a=window.navigator.onLine;return void 0===a?!0:a};
l.Lc=function(){this.j=!0};
l.ha=function(a,b){return this.i.ha(a,b)};
l.nb=function(a){a=bi(this.i,a);a.then(function(b){M("use_cfr_monitor")&&wp().requestComplete("generate_204",b)});
return a};
...
;var oq;function pq(){var a=Ho.call;oq||(oq=new mq({Fr:!0,zr:!0}));a.call(Ho,this,{N:{Hc:lp,Aa:kp,Zb:hp,Xc:ip,Hb:jp,set:fp},L:oq,handleError:bl,Ba:cl,ia:qq,now:R,xc:Mp,Y:rm(),Db:"publicytnetworkstatus-online",Cb:"publicytnetworkstatus-offline",fb:!0,eb:.1,kb:Tk("potential_esf_error_limit",10),J:M,Ia:!(sm()&&rq())});this.j=new Eh;M("networkless_immediately_drop_all_requests")&&mp();ao("LogsDatabaseV2")}
...
function Go(a,b,c,d){function e(A){A=void 0===A?!1:A;var E;if(d.retry&&"www.youtube-nocookie.com"!=h&&(A||M("skip_ls_gel_retry")||"application/json"!==g.headers["Content-Type"]||(E=Do(b,c,m,k)),E)){var F=g.onSuccess,O=g.onFetchSuccess;g.onSuccess=function(N,Q){Eo(E);F(N,Q)};
...
function Hq(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=Fq(a,b,c,d);if(e)return e;e=++Eq.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new Cq(h);if(!of(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new Cq(h);
...
function Ir(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;!c&&M("web_all_payloads_via_jspb")&&cl(new P("transport.flushLogs called for JSON in JSPB only experiment"));new Af(function(d,e){c?(Or(tr.i),Or(tr.h),tr.h=0):(Or(sr.i),Or(sr.h),sr.h=0);if(qr&&qr.isReady())if(M("use_new_in_memory_storage")){var f=a,g=c,h=qr;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,m=new Map;if(void 0!==b)g?(e=Br().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),Nr(k,h,d,f)):(k=Br().extractMatchingEntries({isJspb:g,
cttAuthInfo:b}),m.set(b,k),Lr(m,h,d,e,f));else if(g){e=p(Object.keys(Ar));for(g=e.next();!g.done;g=e.next())m=g.value,g=Br().extractMatchingEntries({isJspb:!0,cttAuthInfo:m}),0<g.length&&k.set(m,g),delete Ar[m];Nr(k,h,d,f)}else{k=p(Object.keys(Ar));for(g=k.next();!g.done;g=k.next()){g=g.value;var q=Br().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0<q.length&&m.set(g,q);delete Ar[g]}Lr(m,h,d,e,f)}}else f=a,k=c,h=qr,f=void 0===f?{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=xr.get(b)||[],e.set(b,
k),Nr(e,h,d,f),xr.delete(b)):(k=new Map,m=wr.get(b)||[],k.set(b,m),Lr(k,h,d,e,f),wr.delete(b)):k?(Nr(xr,h,d,f),xr.clear()):(Lr(wr,h,d,e,f),wr.clear());else Jr(c),d()})}
...
a?tr.i=b:sr.i=b}
function Lr(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(R()),h=a.size,k={};a=p(a);for(var m=a.next();!m.done;k={Sa:k.Sa,qa:k.qa,Da:k.Da,Ua:k.Ua,Ta:k.Ta},m=a.next()){var q=p(m.value);m=q.next().value;q=q.next().value;k.qa=wb({context:ro(b.config_||qo())});if(!Qa(q)&&!M("throw_err_when_logevent_malformed_killswitch")){d();break}k.qa.events=q;(q=yr[m])&&Pr(k.qa,m,q);delete yr[m];k.Da="visitorOnlyApprovedKey"===m;Qr(k.qa,g,k.Da);Rr(e);k.Ua=function(r){M("update_log_event_config")&&ei.S(function(){return x(function(w){return v(w,
Sr(r),0)})});
h--;h||c()};
k.Sa=0;k.Ta=function(r){return function(){r.Sa++;if(e.bypassNetworkless&&1===r.Sa)try{Go(b,"log_event",r.qa,Tr({writeThenSend:!0},r.Da,r.Ua,r.Ta,f)),vr=!1}catch(w){bl(w),d()}h--;h||c()}}(k);
try{Go(b,"log_event",k.qa,Tr(e,k.Da,k.Ua,k.Ta,f)),vr=!1}catch(r){bl(r),d()}}}
function Nr(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(R()),g=a.size,h=new Map([].concat(ja(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new Ek;var r=yo(b.config_||qo());G(k,kj,1,r);q=q?Ur(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())ce(k,3,ek,r.value);(q=zr[m])&&Vr(k,m,q);delete zr[m];m="visitorOnlyApprovedKey"===m;Wr(k,f,m);Rr(d);k=ke(k);m=Tr(d,m,function(w){M("update_log_event_config")&&ei.S(function(){return x(function(t){return v(t,Sr(w),
0)})});
g--;g||c()},function(){g--;
g||c()},e);
m.headers["Content-Type"]="application/json+protobuf";m.postBodyFormat="JSPB";m.postBody=k;Go(b,"log_event","",m);vr=!1}}
function Rr(a){M("always_send_and_write")&&(a.writeThenSend=!1)}
function Tr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,fc:a,dangerousLogToVisitorSession:b,vr:!!e,headers:{},postBodyFormat:"",postBody:""};Xr()&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(R())));return a}
...
;var cs=[];function ds(a,b,c){c=void 0===c?{}:c;var d=yq;L("ytLoggingEventsDefaultDisabled",!1)&&yq===yq&&(d=null);M("web_all_payloads_via_jspb")?cs.push({Eb:a,payload:b,options:c}):$r(a,b,d,c)}
;var es=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",es);
function fs(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||R());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Pq();d=new dk;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.sequenceGroup){e=c.sequenceGroup;var f=as(e),g=new ck;D(g,2,f);D(g,1,e);G(d,ck,3,g);c.endOfSequence&&delete es[c.sequenceGroup]}G(a,dk,33,d);(c.sendIsolatedPayload?Mr:Gr)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,dangerousLogToVisitorSession:c.dangerousLogToVisitorSession},b)}
;function gs(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);fs(a,c?null:yq,b)}
;function hs(a,b,c){var d=new ek;ae(d,Tj,72,fk,a);c?fs(d,c,b):gs(d,b)}
function is(a,b,c){var d=new ek;ae(d,Sj,73,fk,a);c?fs(d,c,b):gs(d,b)}
function js(a,b,c){var d=new ek;ae(d,Rj,78,fk,a);c?fs(d,c,b):gs(d,b)}
function ks(a,b,c){var d=new ek;ae(d,Uj,208,fk,a);c?fs(d,c,b):gs(d,b)}
function ls(a,b,c){var d=new ek;ae(d,Kj,156,fk,a);c?fs(d,c,b):gs(d,b)}
function ms(a,b,c){var d=new ek;ae(d,Oj,215,fk,a);c?fs(d,c,b):gs(d,b)}
;var ns=new Set,os=0,ps=0,qs=0,rs=[],ss=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Cm(a){ts(a)}
...
a.params){var ca=a.params;if("object"===typeof a.params)for(var U in ca){if(ca[U]){var sb="params."+U,Wa=Tl(ca[U]);g[sb]=Wa;N+=sb.length+Wa.length;if(500<N)break}}else g.params=Tl(ca)}if(m.length)for(var oa=0;oa<m.length&&!(N=Rl(m[oa],"params.context."+oa,g,N),500<=N);oa++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var I={message:r,name:w,lineNumber:E,fileName:F,stack:O,params:g,sampleWeight:1},ma=Number(a.columnNumber);isNaN(ma)||(I.lineNumber=I.lineNumber+
":"+ma);if("IGNORED"===a.level)var ea=0;else a:{for(var Ge=Nl(),He=p(Ge.ma),sd=He.next();!sd.done;sd=He.next()){var ra=sd.value;if(I.message&&I.message.match(ra.Gr)){ea=ra.weight;break a}}for(var zp=p(Ge.ka),jk=zp.next();!jk.done;jk=zp.next()){var Ap=jk.value;if(Ap.callback(I)){ea=Ap.weight;break a}}ea=1}I.sampleWeight=ea;for(var Bp=p(Il),kk=Bp.next();!kk.done;kk=Bp.next()){var lk=kk.value;if(lk.jb[I.name])for(var Cp=p(lk.jb[I.name]),mk=Cp.next();!mk.done;mk=Cp.next()){var Dp=mk.value,Wg=I.message.match(Dp.regexp);
...
Bb&&(I.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(I);if(0!==I.sampleWeight&&!ns.has(I.message)){if("ERROR"===h){Ol.ra("handleError",I);if(M("record_app_crashed_web")&&0===qs&&1===I.sampleWeight)if(qs++,M("errors_via_jspb")){var ok=new Dj;D(ok,1,1);if(!M("report_client_error_with_app_crash_ks")){var Gp=new yj;D(Gp,1,I.message);var Hp=new zj;G(Hp,yj,3,Gp);var Ip=new Aj;G(Ip,zj,5,Hp);var Jp=new Bj;G(Jp,Aj,9,Ip);G(ok,Bj,4,Jp)}var Kp=new ek;ae(Kp,Dj,20,
fk,ok);gs(Kp)}else{var Lp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Lp.systemHealth={crashData:{clientError:{logMessage:{message:I.message}}}});ds("appCrashed",Lp)}ps++}else"WARNING"===h&&Ol.ra("handleWarning",I);if(M("kevlar_gel_error_routing"))a:{var Ie=h;if(M("errors_via_jspb")){if(vs())var Np=void 0;else{var ud=new vj;D(ud,1,I.stack);I.fileName&&D(ud,4,I.fileName);var Kb=I.lineNumber&&I.lineNumber.split?I.lineNumber.split(":"):[];0!==Kb.length&&(1!==
Kb.length||isNaN(Number(Kb[0]))?2!==Kb.length||isNaN(Number(Kb[0]))||isNaN(Number(Kb[1]))||(D(ud,2,Number(Kb[0])),D(ud,3,Number(Kb[1]))):D(ud,2,Number(Kb[0])));var zc=new yj;D(zc,1,I.message);D(zc,3,I.name);D(zc,6,I.sampleWeight);"ERROR"===Ie?D(zc,2,2):"WARNING"===Ie?D(zc,2,1):D(zc,2,0);var pk=new wj;D(pk,1,!0);ae(pk,vj,3,xj,ud);var bc=new sj;D(bc,3,window.location.href);for(var Op=L("FEXP_EXPERIMENTS",[]),qk=0;qk<Op.length;qk++){var ow=Op[qk];Fd(bc);Ud(bc,5,2,!1,!1).push(ow)}var rk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Rk()&&rk)for(var Pp=p(Object.keys(rk)),Ac=Pp.next();!Ac.done;Ac=Pp.next()){var Qp=Ac.value,sk=new uj;D(sk,1,Qp);D(sk,2,String(rk[Qp]));ce(bc,4,uj,sk)}var tk=I.params;if(tk){var Rp=p(Object.keys(tk));for(Ac=Rp.next();!Ac.done;Ac=Rp.next()){var Sp=Ac.value,uk=new uj;D(uk,1,"client."+Sp);D(uk,2,String(tk[Sp]));ce(bc,4,uj,uk)}}var Tp=L("SERVER_NAME"),Up=L("SERVER_VERSION");if(Tp&&Up){var vk=new uj;D(vk,1,"server.name");D(vk,2,Tp);ce(bc,4,uj,vk);var wk=new uj;D(wk,1,"server.version");D(wk,2,Up);ce(bc,
4,uj,wk)}var Xg=new zj;G(Xg,sj,1,bc);G(Xg,wj,2,pk);G(Xg,yj,3,zc);Np=Xg}var Vp=Np;if(!Vp)break a;var Wp=new ek;ae(Wp,zj,163,fk,Vp);gs(Wp)}else{if(vs())var Xp=void 0;else{var Je={stackTrace:I.stack};I.fileName&&(Je.filename=I.fileName);var Lb=I.lineNumber&&I.lineNumber.split?I.lineNumber.split(":"):[];0!==Lb.length&&(1!==Lb.length||isNaN(Number(Lb[0]))?2!==Lb.length||isNaN(Number(Lb[0]))||isNaN(Number(Lb[1]))||(Je.lineNumber=Number(Lb[0]),Je.columnNumber=Number(Lb[1])):Je.lineNumber=Number(Lb[0]));
var xk={level:"ERROR_LEVEL_UNKNOWN",message:I.message,errorClassName:I.name,sampleWeight:I.sampleWeight};"ERROR"===Ie?xk.level="ERROR_LEVEL_ERROR":"WARNING"===Ie&&(xk.level="ERROR_LEVEL_WARNNING");var pw={isObfuscated:!0,browserStackInfo:Je},vd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(vd.experimentIds=L("FEXP_EXPERIMENTS"));var yk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Rk()&&yk)for(var Yp=p(Object.keys(yk)),Bc=Yp.next();!Bc.done;Bc=Yp.next()){var Zp=Bc.value;vd.kvPairs.push({key:Zp,
value:String(yk[Zp])})}var zk=I.params;if(zk){var $p=p(Object.keys(zk));for(Bc=$p.next();!Bc.done;Bc=$p.next()){var aq=Bc.value;vd.kvPairs.push({key:"client."+aq,value:String(zk[aq])})}}var bq=L("SERVER_NAME"),cq=L("SERVER_VERSION");bq&&cq&&(vd.kvPairs.push({key:"server.name",value:bq}),vd.kvPairs.push({key:"server.version",value:cq}));Xp={errorMetadata:vd,stackTrace:pw,logMessage:xk}}var dq=Xp;if(!dq)break a;ds("clientError",dq)}if("ERROR"===Ie||M("errors_flush_gel_always_killswitch"))b:{if(M("web_fp_via_jspb")&&
(bs(!0),!M("web_fp_via_jspb_and_json")))break b;bs()}}if(!M("suppress_error_204_logging")){var Ke=I.params||{},cc={urlParams:{a:"logerror",t:"jserror",type:I.name,msg:I.message.substr(0,250),line:I.lineNumber,level:h,"client.name":Ke.name},postParams:{url:L("PAGE_NAME",window.location.href),file:I.fileName},method:"POST"};Ke.version&&(cc["client.version"]=Ke.version);if(cc.postParams){I.stack&&(cc.postParams.stack=I.stack);for(var eq=p(Object.keys(Ke)),Ak=eq.next();!Ak.done;Ak=eq.next()){var fq=Ak.value;
cc.postParams["client."+fq]=Ke[fq]}var Bk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(Bk)for(var gq=p(Object.keys(Bk)),Ck=gq.next();!Ck.done;Ck=gq.next()){var hq=Ck.value;cc.postParams[hq]=Bk[hq]}var iq=L("SERVER_NAME"),jq=L("SERVER_VERSION");iq&&jq&&(cc.postParams["server.name"]=iq,cc.postParams["server.version"]=jq)}yl(L("ECATCHER_REPORT_HOST","")+"/error_204",cc)}try{ns.add(I.message)}catch(Rx){}os++}}}}
function vs(){for(var a=p(ss),b=a.next();!b.done;b=a.next())if(Hl(b.value.toLowerCase()))return!0;return!1}
function ws(a){var b=Ka.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,ja(b))}
;function xs(){this.register=new Map}
function ys(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Kr("ABORTED")}
...
return a.join("")}
;var Cs=y.ytLoggingDocDocumentNonce_;Cs||(Cs=Bs(),z("ytLoggingDocDocumentNonce_",Cs));var Ds=Cs;var Es={di:0,xe:1,He:2,cm:3,gi:4,Gq:5,Sm:6,Ko:7,Zn:8,yo:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function Fs(a){this.G=a}
...
z("yt_logging_screen.getCttAuthInfo",Os);function Ps(a,b,c,d){c=void 0===c?0:c;if(a!==L(Hs(c))||b!==L(Is(c)))if(Ns(a,d,c),Qk(Hs(c),a),Qk(Is(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new Gj;D(e,1,Ds);D(e,2,a);var f=new ek;ae(f,Gj,111,fk,e);gs(f)}else ds("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Ds,clientScreenNonce:a})},0)},"requestAnimationFrame"in window)try{window.requestAnimationFrame(b)}catch(e){b()}else b()}
z("yt_logging_screen.setCurrentScreen",Ps);function Dm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts"))ds(a,b,c);else{var d=yq;L("ytLoggingEventsDefaultDisabled",!1)&&yq==yq&&(d=null);$r(a,b,d,c)}}
;var Qs=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};z("yt.msgs_",Qs);function Rs(a){Lk(Qs,arguments)}
;var Ss={we:3611,Bd:27686,Cd:85013,Dd:23462,Fd:157557,Gd:42016,Hd:62407,Id:26926,Ed:43781,Jd:51236,Kd:79148,Ld:50160,Md:77504,Yd:153587,Zd:87907,ae:18630,be:54445,ce:80935,de:152172,ee:105675,ge:150723,he:37521,ie:147285,je:47786,ke:98349,le:168271,me:168954,ne:168277,oe:168273,pe:168270,qe:123695,re:6827,se:29434,te:7282,ue:124448,ze:32276,ye:76278,Ae:147868,Be:147869,Ce:93911,De:106531,Ee:27259,Fe:27262,Ge:27263,Ie:21759,Je:27107,Ke:62936,Le:160866,Me:49568,Ne:160789,Oe:38408,Pe:80637,Qe:68727,Re:68728,
...
Bj:26970,Cj:26971,Dj:96805,Ej:17752,Fj:73233,Gj:109512,Hj:22256,Ij:14115,Jj:22696,Kj:89278,Lj:89277,Mj:109513,Nj:43278,Oj:43459,Pj:43464,Qj:89279,Rj:43717,Sj:55764,Tj:22255,Uj:147912,Vj:89281,Wj:40963,Xj:43277,Yj:43442,Zj:91824,ak:120137,bk:96367,ck:36850,dk:72694,ek:37414,fk:36851,hk:124863,gk:121343,ik:73491,jk:54473,kk:166861,lk:43375,mk:46674,nk:143815,pk:139095,qk:144402,rk:149968,sk:149969,tk:32473,uk:72901,vk:72906,wk:50947,xk:50612,yk:50613,zk:50942,Ak:84938,Bk:84943,Ck:84939,Dk:84941,Ek:84944,
Fk:84940,Gk:84942,Hk:35585,Ik:51926,Jk:79983,Kk:63238,Lk:18921,Mk:63241,Nk:57893,Ok:41182,Pk:135732,Qk:33424,Rk:22207,Sk:42993,Tk:36229,Uk:22206,Vk:22205,Wk:18993,Xk:19001,Yk:18990,Zk:18991,al:18997,bl:18725,dl:19003,fl:36874,il:44763,jl:33427,kl:67793,ll:22182,ml:37091,nl:34650,ol:50617,pl:47261,ql:22287,rl:25144,sl:97917,ul:62397,vl:150871,wl:150874,xl:125598,yl:137935,zl:36961,Al:108035,Bl:27426,Cl:27857,Dl:27846,El:27854,Fl:69692,Gl:61411,Hl:39299,Il:38696,Jl:62520,Kl:36382,Ll:108701,Ml:50663,
Nl:36387,Ol:14908,Pl:37533,Ql:105443,Rl:61635,Sl:62274,Tl:161670,Ul:133818,Vl:65702,Wl:65703,Xl:65701,Yl:76256,Zl:166382,am:37671,bm:49953,dm:36216,em:28237,fm:39553,gm:29222,hm:26107,im:38050,jm:26108,lm:120745,km:26109,mm:26110,nm:66881,om:28236,pm:14586,qm:160598,rm:57929,sm:74723,tm:44098,um:44099,xm:23528,ym:61699,vm:134104,wm:134103,zm:59149,Am:101951,Bm:97346,Cm:118051,Dm:95102,Em:64882,Fm:119505,Gm:63595,Hm:63349,Im:95101,Jm:75240,Km:27039,Lm:68823,Mm:21537,Nm:83464,Om:75707,Pm:83113,Qm:101952,
Rm:101953,Tm:79610,Um:125755,Vm:24402,Wm:24400,Xm:32925,Zm:57173,Ym:156421,an:122502,bn:145268,cn:138480,dn:64423,en:64424,fn:33986,gn:100828,hn:129089,jn:21409,nn:135155,pn:135156,qn:135157,rn:135158,sn:158225,tn:135159,un:135160,vn:167651,wn:135161,yn:135162,zn:135163,xn:158226,An:158227,Bn:135164,Cn:135165,Dn:135166,kn:11070,ln:11074,mn:17880,En:14001,Gn:30709,Hn:30707,In:30711,Jn:30710,Kn:30708,Fn:26984,Ln:146143,Mn:63648,Nn:63649,On:111059,Pn:5754,Qn:20445,Rn:151308,Sn:151152,Vn:130975,Un:130976,
Tn:167637,Wn:110386,Xn:113746,Yn:66557,ao:17310,bo:28631,co:21589,eo:164817,fo:168011,ho:154946,jo:68012,ko:162617,lo:60480,mo:138664,no:141121,oo:164502,po:31571,qo:141978,ro:150105,so:150106,to:150107,uo:150108,vo:76980,wo:41577,xo:45469,zo:38669,Ao:13768,Bo:13777,Co:141842,Do:62985,Eo:4724,Fo:59369,Go:43927,Ho:43928,Io:12924,Jo:100355,Mo:56219,No:27669,Oo:10337,Lo:47896,Po:122629,Ro:139723,Qo:139722,So:121258,To:107598,Uo:127991,Vo:96639,Wo:107536,Xo:130169,Yo:96661,Zo:145188,ap:96658,bp:116646,
cp:159428,ep:121122,fp:96660,gp:127738,hp:127083,ip:155281,jp:162959,kp:163566,lp:147842,mp:104443,np:96659,qp:147595,rp:106442,sp:162776,tp:134840,up:63667,vp:63668,wp:63669,xp:130686,yp:147036,zp:78314,Ap:147799,Bp:148649,Cp:55761,Dp:127098,Ep:134841,Fp:96368,Gp:67374,Hp:48992,Ip:146176,Jp:49956,Kp:31961,Lp:26388,Mp:23811,Np:5E4,Op:126250,Pp:96370,Qp:47355,Rp:47356,Sp:37935,Tp:45521,Up:21760,Vp:83769,Wp:49977,Xp:49974,Yp:93497,Zp:93498,aq:34325,bq:140759,cq:115803,fq:123707,gq:100081,hq:35309,iq:68314,
jq:25602,kq:100339,lq:143516,mq:59018,nq:18248,oq:50625,pq:9729,qq:37168,rq:37169,sq:21667,tq:16749,uq:18635,wq:39305,xq:18046,yq:53969,zq:8213,Aq:93926,Bq:102852,Cq:110099,Dq:22678,Eq:69076,Fq:137575,Hq:139224,Iq:100856,Jq:154430,Kq:17736,Lq:3832,Mq:147111,Nq:55759,Oq:64031,Uq:93044,Vq:93045,Xq:34388,Wq:167841,Yq:17657,Zq:17655,br:39579,dr:39578,er:77448,fr:8196,gr:11357,hr:69877,ir:8197,jr:168501,kr:156512,lr:161613,mr:156509,pr:161612,qr:161614,rr:82039};function Ts(){var a=vb(Us),b;return(new Af(function(c,d){a.onSuccess=function(e){rl(e)?c(new Vs(e)):d(new Ws("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
;function at(){return vg()||Gl&&Hl("applewebkit")&&!Hl("version")&&(!Hl("safari")||Hl("gsa/"))||Nc&&Hl("version/")?!0:L("EOM_VISITOR_DATA")?!1:!0}
...
function Xk(){var a=ft();if(void 0!==a)return Ff(a);et||(et=Ts().then(gt).pb(function(b){return ht(2,b)}));
return et}
function gt(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new dt;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new dt;a=a.id;Yk(a);et=Ys(a);jt(18E5,2);return a}
function ht(a,b){b=new ct(b);Yk("");et=Zs(b);0<a&&jt(12E4,a-1);throw b;}
function jt(a,b){sl(function(){Ts().then(gt,function(c){return ht(b,c)}).pb(db)},a)}
function kt(){try{var a=B("yt.ads.biscotti.getId_");return a?a():Xk()}catch(b){return Ff(b)}}
;function lt(a){if("1"!=tb(L("PLAYER_VARS",{}))){a&&Wk();try{kt().then(function(){},function(){}),sl(lt,18E5)}catch(b){bl(b)}}}
;function mt(){var a=$l.getInstance(),b=cm(119),c=1<window.devicePixelRatio;if(document.body&&oi(document.body,"exp-invert-logo"))if(c&&!oi(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!oi(d,"inverted-hdpi")){var e=mi(d);ni(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&oi(document.body,"inverted-hdpi")&&pi();if(b!=c){b="f"+(Math.floor(119/31)+1);d=dm(b)||0;d=c?d|67108864:d&-67108865;0==d?delete Zl[b]:(c=d.toString(16),Zl[b]=
...
;function st(){this.h={};if(this.i=Yl()){var a=tg.get("CONSISTENCY",void 0);a&&tt(this,{encryptedTokenJarContents:a})}}
...
l.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.i=void 0,"TVHTML5"===L("INNERTUBE_CLIENT_NAME")?(this.h=wt(this))&&this.h.set("yt-location-playability-token",a,15552E3):Wl("YT_CL",JSON.stringify({loctok:a}),15552E3,ut,!0))};
function wt(a){return void 0===a.h?new um("yt-client-location"):a.h}
l.clearLocationPlayabilityToken=function(a){"TVHTML5"===a?(this.h=wt(this))&&this.h.remove("yt-location-playability-token"):Xl("YT_CL")};
...
p(Object.entries(A));for(var O=F.next();!O.done;O=F.next()){var N=p(O.value),Q=N.next().value,ca=N.next().value;A=Q;E=ca;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:A,value:""+E})}}catch(sb){ts(sb)}F=g}else ts(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(O=this.h(a)){this.i(F,O,b);var U;b="/youtubei/v1/"+Dt(this.j());(O=null==(U=mr(a.commandMetadata,nj))?void 0:U.apiUrl)&&(b=O);U=b;(b=L("INNERTUBE_HOST_OVERRIDE"))&&(U=String(b)+String(pc(U)));b=
...
;function Nt(a,b){Qo.call(this,1,arguments);this.timer=b}
u(Nt,Qo);var Ot=new Ro("aft-recorded",Nt);var Pt=window;function Qt(){this.timing={};this.clearResourceTimings=function(){};
...
function eu(a){var b=Ut("_start",a),c=Tt(a);b&&c&&!Rt&&(Wo(Ot,new Nt(Math.round(c-b),a)),Rt=!0)}
...
Bu.prototype.tick=function(a,b,c,d){Du(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new bk,D(d,1,a),D(d,2,b),a=new ek,ae(a,bk,5,fk,d),gs(a,c)):ds("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
Bu.prototype.info=function(a,b,c){var d=Object.keys(a).join("");Du(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,ds("latencyActionInfo",a,{cttAuthInfo:c}))};
Bu.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));Du(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new ek,ae(c,Xj,7,fk,a),gs(c,b))};
Bu.prototype.span=function(a,b,c){var d=Object.keys(a).join("");Du(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,ds("latencyActionSpan",a,{cttAuthInfo:c}))};
function Du(a,b){Au[b]=Au[b]||{count:0};var c=Au[b];c.count++;c.time=R();a.h||(a.h=mm(function(){var d=R(),e;for(e in Au)Au[e]&&6E4<d-Au[e].time&&delete Au[e];a&&(a.h=0)},5E3));
...
D(b,13,W[pu(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=Ms())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=Gu();1!==a&&-1!==a||D(b,6,!0);a=Zt();M("skip_setting_info_in_csi_data_object")&&$t();D(b,3,"cold");Hu(a);a=Iu();if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Wj,D(d,1,c),ce(b,83,Wj,d);Fu(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&Ju(b,a[b]);b={isNavigation:!0,actionType:pu(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=
...
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}d=iu(c||"");d.tick[a]=b||R();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=bu(c);d.gelTicks&&(d.gelTicks[a]=!0);e=au(c);d=b||R();M("log_repeated_ytcsi_ticks")?a in e||(e[a]=d):e[a]=d;e=du(c);var f=Yt(c).cttAuthInfo;"_start"===a?(a=Cu(),Du(a,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(a=new Vj,
D(a,1,e),e=new ek,ae(e,Vj,6,fk,a),gs(e,b)):ds("latencyActionBaselined",{clientActionNonce:e},b))):Cu().tick(a,e,b,f);eu(c);return d}
function Lu(){var a=du();requestAnimationFrame(function(){setTimeout(function(){a===du()&&Z("ol",void 0,void 0)},0)})}
function Gu(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=Aq+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
...
function Tu(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?pt:c;var d=zt(b,a.m);if(!d)return Ff(new P("Error: No request builder found for command.",b));var e=d.m(b,void 0,c);return e?new Af(function(f){var g,h,k;return x(function(m){if(1==m.h){h="cors"===(null==(g=e.wa)?void 0:g.mode)?"cors":void 0;if(a.l.ud){var q=e.config,r;q=null==q?void 0:null==(r=q.Za)?void 0:r.sessionIndex;r=ot({sessionIndex:q});k=Object.assign({},Uu(h),r);return m.u(2)}return v(m,Vu(e.config,
h),3)}2!=m.h&&(k=m.i);f(Wu(a,e,k));m.h=0})}):Ff(new P("Error: Failed to build request for command.",b))}
function Xu(a,b,c){var d;if(b&&!(null==b?0:null==(d=b.Nr)?0:d.Qr)&&a.j){d=p(Pu);for(var e=d.next();!e.done;e=d.next())e=e.value,a.j[e]&&a.j[e].handleResponse(b,c)}}
function Wu(a,b,c){var d,e,f,g,h,k,m,q,r,w,t,A,E,F,O,N,Q,ca,U,sb,Wa,oa,I,ma,ea,Ge,He,sd;return x(function(ra){switch(ra.h){case 1:ra.u(2);break;case 3:if((d=ra.i)&&!d.isExpired())return ra.return(Promise.resolve(d.h()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Jr(b.ga.context);if(null==(m=a.i)||!m.Or(b.input,b.ga)){ra.u(4);break}return v(ra,a.i.Er(b.input,b.ga),5);case 5:return q=ra.i,M("kevlar_process_local_innertube_responses_killswitch")||
Xu(a,q,b),ra.return(q);case 4:return(t=null==(w=b.config)?void 0:w.na)&&a.h.has(t)&&M("web_memoize_inflight_requests")?r=a.h.get(t):(A=JSON.stringify(b.ga),O=null!=(F=null==(E=b.wa)?void 0:E.headers)?F:{},b.wa=Object.assign({},b.wa,{headers:Object.assign({},O,c)}),N=Object.assign({},b.wa),"POST"===b.wa.method&&(N=Object.assign({},N,{body:A})),(null==(Q=b.config)?0:Q.gd)&&Z(b.config.gd),ca=function(){return a.L.fetch(b.input,N,b.config)},r=ca(),t&&a.h.set(t,r)),v(ra,r,6);
case 6:if((U=ra.i)&&"error"in U&&(null==(sb=U)?0:null==(Wa=sb.error)?0:Wa.details))for(oa=U.error.details,I=p(oa),ma=I.next();!ma.done;ma=I.next())ea=ma.value,(Ge=ea["@type"])&&-1<Qu.indexOf(Ge)&&(delete ea["@type"],U=ea);t&&a.h.has(t)&&a.h.delete(t);(null==(He=b.config)?0:He.hd)&&Z(b.config.hd);if(U||null==(sd=a.i)||!sd.wr(b.input,b.ga)){ra.u(7);break}return v(ra,a.i.Dr(b.input,b.ga),8);case 8:U=ra.i;case 7:return Xu(a,U,b),ra.return(U||void 0)}})}
...
;var Yu=new ar("INNERTUBE_TRANSPORT_TOKEN");var Zu=["share/get_web_player_share_panel"],$u=["feedback"],av=["notification/modify_channel_preference"],bv=["browse/edit_playlist"],cv=["subscription/subscribe"],dv=["subscription/unsubscribe"];function ev(){}
u(ev,Et);ev.prototype.j=function(){return cv};
ev.prototype.h=function(a){return mr(a,Kk)||void 0};
...
fv.prototype.h=function(a){return mr(a,Jk)||void 0};
...
gv.prototype.h=function(a){return mr(a,qj)||void 0};
...
hv.prototype.h=function(a){return mr(a,Ik)||void 0};
...
iv.prototype.h=function(a){return mr(a,Hk)||void 0};
...
jv.prototype.h=function(a){return mr(a,Gk)};
jv.prototype.i=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var cr=new ar("NETWORK_SLI_TOKEN");function kv(a){this.h=a}
...
a.redirected||a.ok?this.h&&this.h.success():(this.h&&this.h.Ar(),b=b.then(function(c){us(new P("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
kv[$q]=[new br];var lv=new ar("NETWORK_MANAGER_TOKEN");var mv;function nv(a){Qo.call(this,1,arguments);this.csn=a}
u(nv,Qo);var Zo=new Ro("screen-created",nv),ov=[],qv=pv,rv=0;function sv(a,b,c,d,e,f,g){function h(){us(new P("newScreen() parent element does not have a VE - rootVe",b))}
var k=qv(),m=new Fs({veType:b,youtubeData:f,jspbYoutubeData:void 0});f={sequenceGroup:k};e&&(f.cttAuthInfo=e);M("il_via_jspb")?(e=Lj((new Kj).i(k),m.getAsJspb()),c&&c.visualElement?(m=new Mj,c.clientScreenNonce&&D(m,2,c.clientScreenNonce),Nj(m,c.visualElement.getAsJspb()),g&&D(m,4,gk[g]),G(e,Mj,5,m)):c&&h(),d&&D(e,3,d),ls(e,f,a)):(e={csn:k,pageVe:m.getAsJson()},c&&c.visualElement?(e.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(e.implicitGesture.gestureType=
g)):c&&h(),d&&(e.cloneCsn=d),a?$r("screenCreated",e,a,f):ds("screenCreated",e,f));Wo(Zo,new nv(k));return k}
function tv(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:Os(b)||void 0,
sequenceGroup:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(qb(g)||!g.trackingParams&&!g.veType)&&us(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=Qj((new Oj).i(b),c.getAsJspb());ib(e,function(k){k=k.getAsJspb();ce(h,3,Fj,k)});
"UNDEFINED_CSN"===b?uv("visualElementAttached",f,void 0,h):ms(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:ib(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"===b?uv("visualElementAttached",f,c):a?$r("visualElementAttached",c,a,f):ds("visualElementAttached",c,f)}
function vv(a,b,c,d,e,f){wv(a,b,c,e,f)}
function wv(a,b,c,d,e){var f={cttAuthInfo:Os(b)||void 0,sequenceGroup:b};M("il_via_jspb")?(d=(new Tj).i(b),c=c.getAsJspb(),c=G(d,Fj,2,c),c=D(c,4,1),e&&G(c,Ij,3,e),"UNDEFINED_CSN"===b?uv("visualElementShown",f,void 0,c):hs(c,f,a)):(e={csn:b,ve:c.getAsJson(),eventType:1},d&&(e.clientData=d),"UNDEFINED_CSN"===b?uv("visualElementShown",f,e):a?$r("visualElementShown",e,a,f):ds("visualElementShown",e,f))}
...
function uv(a,b,c,d){ov.push({Eb:a,payload:c,la:d,options:b});rv||(rv=$o())}
function ap(a){if(ov){for(var b=p(ov),c=b.next();!c.done;c=b.next())if(c=c.value,M("il_via_jspb")&&c.la)switch(c.la.i(a.csn),c.Eb){case "screenCreated":ls(c.la,c.options);break;case "visualElementAttached":ms(c.la,c.options);break;case "visualElementShown":hs(c.la,c.options);break;case "visualElementHidden":is(c.la,c.options);break;case "visualElementGestured":js(c.la,c.options);break;case "visualElementStateChanged":ks(c.la,c.options);break;default:us(new P("flushQueue unable to map payloadName to JSPB setter"))}else c.payload&&
(c.payload.csn=a.csn,ds(c.Eb,c.payload,c.options));ov.length=0}rv=0}
;function xv(){this.l=new Set;this.h=new Set;this.m=new Map;this.client=yq;this.csn=null}
...
zv.prototype.i=function(a){M("safe_logging_library_killswitch")?this.client=a:al(yv().i).bind(yv())(a)};
zv.prototype.clear=function(){M("safe_logging_library_killswitch")?(this.j.clear(),this.h.clear(),this.l.clear(),this.csn=null):al(yv().clear).bind(yv())()};function Bv(){this.j=new Set;this.h=new Set;this.l=new Map}
...
Cv.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=Ms(void 0===c?0:c)){a=this.client;var e=Gs(d);d={cttAuthInfo:Os(c)||void 0,sequenceGroup:c};M("il_via_jspb")?(b=(new Rj).i(c),e=e.getAsJspb(),b=G(b,Fj,2,e),D(b,4,gk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK),"UNDEFINED_CSN"===c?uv("visualElementGestured",d,void 0,b):js(b,d,a)):(e={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(e.clientData=b),"UNDEFINED_CSN"===
c?uv("visualElementGestured",d,e):a?$r("visualElementGestured",e,a,d):ds("visualElementGestured",e,d));b=!0}else b=!1;else b=!1;return b};
Cv.prototype.visualElementStateChanged=function(a,b,c){c=void 0===c?0:c;0===c&&this.j.has(c)?this.v.push([a,b]):Fv(this,a,b,c)};
function Fv(a,b,c,d){d=void 0===d?0:d;var e=Ms(d);d=b||Ks(d);e&&d&&(a=a.client,b={cttAuthInfo:Os(e)||void 0,sequenceGroup:e},M("il_via_jspb")?(c=new Uj,c.i(e),d=d.getAsJspb(),G(c,Fj,2,d),"UNDEFINED_CSN"===e?uv("visualElementStateChanged",b,void 0,c):ks(c,b,a)):(c={csn:e,ve:d.getAsJson(),clientData:c},"UNDEFINED_CSN"===e?uv("visualElementStateChanged",b,c):a?$r("visualElementStateChanged",c,a,b):ds("visualElementStateChanged",c,b)))}
...
function Hv(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.bd?c.bd:c.layer;var e=Ms(d);d=Ks(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=sv(a.client,b,f,c.Vb,c.cttAuthInfo,g,c.Br)}catch(m){ws(m,{Lr:b,rootVe:d,Ir:void 0,xr:e,Hr:f,Vb:c.Vb});ts(m);return}Ps(k,b,c.layer,c.cttAuthInfo);
if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(Es));for(f=b.next();!f.done;f=b.next())if(Ms(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:Os(e)||void 0,sequenceGroup:e,endOfSequence:g},M("il_via_jspb")?(h=(new Sj).i(e),d=d.getAsJspb(),d=G(h,Fj,2,d),D(d,4,g?16:8),"UNDEFINED_CSN"===e?uv("visualElementHidden",f,void 0,d):is(d,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"===e?uv("visualElementHidden",f,d):b?$r("visualElementHidden",
d,b,f):ds("visualElementHidden",d,f)));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=k||"");Ku({clientScreenNonce:k});d=Bv.getInstance();M("use_ts_visibilitylogger")?(d=Av(),M("safe_logging_library_killswitch")?(d.clear(),d.csn=Ms()):al(yv().j).bind(yv())()):d.clear();d=Ks(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,M("safe_logging_library_killswitch")?wv(void 0,e,d):al(vv)(void 0,e,d,void 0,void 0,void 0));a.j.delete(c.layer||
...
;function Iv(){var a,b,c;return x(function(d){if(1==d.h)return a=hr().resolve(Yu),a?v(d,Tu(a),2):(us(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),d.return(void 0));if(b=d.i){if(b.errorMetadata)return us(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),d.return(void 0);c=b.yr;return d.return(c)}us(Error("Network request to get Datasync IDs failed."));return d.return(void 0)})}
;var Jv=y.caches,Kv;function Lv(a){var b=a.indexOf(":");return-1===b?{ic:a}:{ic:a.substring(0,b),datasyncId:a.substring(b+1)}}
...
function Ov(){var a,b,c,d,e,f,g;return x(function(h){if(1==h.h)return v(h,Mv(),2);if(3!=h.h){if(!h.i)return h.return(!1);a=tm("cache contains other");return v(h,Jv.keys(),3)}b=h.i;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=Lv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
...
function Sv(){if(!Pv())return!1;var a=tm(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=Qv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function Tv(){Iv().then(function(a){a&&(Sn(a),Nv(a),Rv(a))})}
function Uv(){var a=new mq;ei.S(function(){var b,c,d,e;return x(function(f){switch(f.h){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=tm("clear");if(b.startsWith("V")){var g=[b];Sn(g);Nv(g);Rv(g);return f.return()}c=Sv();return v(f,Ov(),3);case 3:return d=f.i,v(f,Tn(),4);case 4:if(e=f.i,!c&&!d&&!e)return f.return();case 2:a.U()?Tv():a.l.add("publicytnetworkstatus-online",Tv,!0,void 0,void 0),f.h=0}})})}
...
function bw(a,b,c){c=void 0===c?null:c;var d=cw(a),e=document.getElementById(d),f=e&&Xv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Uq(d,b),b=""+Sa(b),dw[b]=f),g||(e=ew(a,d,function(){Xv(e,"loaded")||(Vv(e),Xq(d),sl(Za(Yq,d),0))},c)))}
...
function fw(a){a=cw(a);var b=document.getElementById(a);b&&(Yq(a),b.parentNode.removeChild(b))}
function gw(a,b){a&&b&&(a=""+Sa(b),(a=dw[a])&&Wq(a))}
function cw(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var dw={};var hw=[],iw=!1;function jw(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&at()){var a=L("PLAYER_VARS",{});if("1"!=tb(a)&&!bt(a)){var b=function(){iw=!0;"google_ad_status"in window?Qk("DCLKSTAT",1):Qk("DCLKSTAT",2)};
...
e=nm(d,mw(this,a.Ea));this.h[a.Qa]=Object.assign({},a.Ea,{Ab:d,jobId:e})}}
...
rm();var g={};e=p(e);for(var h=e.next();!h.done;g={Ra:g.Ra},h=e.next())g.Ra=h.value,pm(function(k){return function(){k.Ra.callback.apply(k.Ra,ja(d))}}(g));
...
var ww;u(vw,uw);vw.prototype.l=function(){if(M("web_fp_via_jspb")){var a=new Ej,b=Ms();b&&D(a,1,b);b=new ek;ae(b,Ej,380,fk,a);gs(b);M("web_fp_via_jspb_and_json")&&ds("finalPayload",{csn:Ms()})}else ds("finalPayload",{csn:Ms()})};
...
z("ytglobal.storageClass_",xw);function Bm(a,b){var c=this;this.handleError=a;this.h=b;this.i=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.i=!0});
...
u(Bw,J);Bw.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.i&&(a.channel=this.i);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){cl(d)}}};
Bw.prototype.B=function(){window.removeEventListener("message",this.F);J.prototype.B.call(this)};function Cw(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new Bw(!!L("WIDGET_ID_ENFORCE")),b=this.dd.bind(this);a.o=b;a.s=null;this.h.i="widget";if(a=L("WIDGET_ID"))this.h.sessionId=a}
l=Cw.prototype;l.dd=function(a,b,c){"addEventListener"===a&&b?this.zb(b[0],c):this.Kb(a,b,c)};
l.Kb=function(){};
l.sb=function(a){var b=this;return function(c){return b.sendMessage(a,c)}};
l.zb=function(a,b){this.j[a]||"onReady"===a||(this.addEventListener(a,this.sb(a,b)),this.j[a]=!0)};
l.addEventListener=function(){};
l.Oc=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.vb());this.sendMessage("onReady");gb(this.i,this.oc,this);this.i=[]};
l.vb=function(){return null};
function Dw(a,b){a.sendMessage("infoDelivery",b)}
l.oc=function(a){this.isReady?this.h.sendMessage(a):this.i.push(a)};
l.sendMessage=function(a,b){this.oc({event:a,info:void 0===b?null:b})};
...
function Jw(a,b,c,d){if(Ra(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function Kw(a){Cw.call(this);this.listeners=[];this.l=!1;this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.od.bind(this));this.addEventListener("onVolumeChange",this.pd.bind(this));this.addEventListener("onApiChange",this.jd.bind(this));this.addEventListener("onPlaybackQualityChange",this.ld.bind(this));this.addEventListener("onPlaybackRateChange",this.md.bind(this));this.addEventListener("onStateChange",this.nd.bind(this));this.addEventListener("onWebglSettingsChanged",
this.qd.bind(this))}
u(Kw,Cw);l=Kw.prototype;
l.Kb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Hw(a)){var d=b;if(Ra(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=Iw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=Iw(e);break;case "loadPlaylist":case "cuePlaylist":e=Jw(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);Hw(a)&&Dw(this,this.vb())}};
l.zb=function(a,b){("onReady"===a||"onError"===a&&this.l)&&this.api.logApiCall(a+" invocation",b);this.api.logApiCall(a+" registration",b);Cw.prototype.zb.call(this,a,b)};
l.sb=function(a,b){var c=this,d=Cw.prototype.sb.call(this,a,b);return function(e){c.api.logApiCall(a+" invocation",b);d(e)}};
l.onReady=function(){var a=this.Oc.bind(this);this.h.j=a;a=this.api.getVideoData();if(!a.isPlayable){this.l=!0;a=a.errorCode;var b=void 0===b?5:b;this.sendMessage("onError",(a?Fw[a]||b:b).toString())}};
l.addEventListener=function(a,b){this.listeners.push({eventType:a,listener:b});this.api.addEventListener(a,b)};
l.vb=function(){if(!this.api)return null;var a=this.api.getApiInterface();lb(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.api[e]();b[f]=g}catch(h){}}}b.videoData=this.api.getVideoData();b.currentTimeLastUpdated_=Date.now()/1E3;return b};
...
l.ld=function(a){Dw(this,{playbackQuality:a})};
l.md=function(a){Dw(this,{playbackRate:a})};
...
l.pd=function(){Dw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
l.qd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};Dw(this,a)};
l.dispose=function(){Cw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function Lw(a){J.call(this);this.i={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.kc,this)}
u(Lw,J);l=Lw.prototype;l.start=function(){this.started||this.h()||(this.started=!0,this.connection.xa("RECEIVING"))};
l.xa=function(a,b){this.started&&!this.h()&&this.connection.xa(a,b)};
l.kc=function(a,b,c){if(this.started&&!this.h()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=Mw(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=Nw(a,c))&&this.xa(a,c))}}};
l.addListener=function(a){if(!(a in this.i)){var b=this.kd.bind(this,a);this.i[a]=b;this.addEventListener(a,b)}};
l.kd=function(a,b){this.started&&!this.h()&&this.connection.xa(a,this.ub(a,b))};
l.ub=function(a,b){if(null!=b)return{value:b}};
l.removeListener=function(a){a in this.i&&(this.removeEventListener(a,this.i[a]),delete this.i[a])};
l.B=function(){var a=this.connection;a.h()||Bi(a.i,"command",this.kc,this);this.connection=null;for(var b in this.i)this.i.hasOwnProperty(b)&&this.removeListener(b);J.prototype.B.call(this)};function Ow(a,b){Lw.call(this,b);this.api=a;this.start()}
...
Ow.prototype.ub=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Lw.prototype.ub.call(this,a,b)};
Ow.prototype.B=function(){Lw.prototype.B.call(this);delete this.api};function Pw(a){a=void 0===a?!1:a;J.call(this);this.i=new K(a);ue(this,this.i)}
$a(Pw,J);Pw.prototype.subscribe=function(a,b,c){return this.h()?0:this.i.subscribe(a,b,c)};
Pw.prototype.m=function(a,b){this.h()||this.i.ra.apply(this.i,arguments)};function Qw(a,b,c){Pw.call(this);this.l=a;this.j=b;this.id=c}
u(Qw,Pw);Qw.prototype.xa=function(a,b){this.h()||this.l.xa(this.j,this.id,a,b)};
Qw.prototype.B=function(){this.j=this.l=null;Pw.prototype.B.call(this)};function Rw(a,b,c){J.call(this);this.i=a;this.origin=c;this.j=Hq(window,"message",this.l.bind(this));this.connection=new Qw(this,a,b);ue(this,this.connection)}
u(Rw,J);Rw.prototype.xa=function(a,b,c,d){this.h()||a!==this.i||(a={id:b,command:c},d&&(a.data=d),this.i.postMessage(JSON.stringify(a),this.origin))};
...
Rw.prototype.B=function(){Iq(this.j);this.i=null;J.prototype.B.call(this)};function Sw(){this.state=1;this.h=null}
l=Sw.prototype;
l.initialize=function(a,b,c){if(a.program){var d,e=null!=(d=a.interpreterScript)?d:null,f;d=null!=(f=a.interpreterUrl)?f:null;a.interpreterSafeScript&&(e=a.interpreterSafeScript,Db("From proto message. b/166824318"),e=e.privateDoNotAccessOrElseSafeScriptWrappedValue||"",e=(f=Ab())?f.createScript(e):e,e=(new Fb(e)).toString());a.interpreterSafeUrl&&(d=a.interpreterSafeUrl,Db("From proto message. b/166824318"),d=Jb(d.privateDoNotAccessOrElseTrustedResourceUrlWrappedValue||"").toString());Tw(this,e,
d,a.program,b,c)}else us(Error("Cannot initialize botguard without program"))};
function Tw(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,aw(c,function(){window[g]?Uw(a,d,g,e):(a.state=3,fw(c),us(new P("Unable to load Botguard","from "+c)))},f)):b?(f=nf("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Uw(a,d,g,e):(a.state=4,us(new P("Unable to load Botguard from JS")))):us(new P("Unable to load VM; no url or JS provided"))}
function Uw(a,b,c,d){a.state=5;try{var e=new Fh({program:b,Rc:c,ed:M("att_web_record_metrics")});e.rd.then(function(){a.state=6;d&&d(b)});
a.Ib(e)}catch(f){a.state=7,f instanceof Error&&us(f)}}
l.invoke=function(a){a=void 0===a?{}:a;return this.Jb()?this.wc({Ub:a}):null};
l.dispose=function(){this.Lb()};
l.Lb=function(){this.Ib(null);this.state=8};
l.Jb=function(){return!!this.h};
l.wc=function(a){return this.h.qc(a)};
l.Ib=function(a){se(this.h);this.h=a};function Vw(){var a=B("yt.abuse.playerAttLoader");return a&&["bgvma","bgvmb","bgvmc"].every(function(b){return b in a})?a:null}
;function Ww(){Sw.apply(this,arguments)}
u(Ww,Sw);Ww.prototype.Lb=function(){this.state=8};
Ww.prototype.Ib=function(a){var b;null==(b=Vw())||b.bgvma();a?(b={bgvma:a.dispose.bind(a),bgvmb:a.snapshot.bind(a),bgvmc:a.qc.bind(a)},z("yt.abuse.playerAttLoader",b),z("yt.abuse.playerAttLoaderRun",function(c){return a.snapshot(c)})):(z("yt.abuse.playerAttLoader",null),z("yt.abuse.playerAttLoaderRun",null))};
Ww.prototype.Jb=function(){return!!Vw()};
Ww.prototype.wc=function(a){return Vw().bgvmc(a)};var Xw=new Ww;function Yw(){return Xw.Jb()}
function Zw(a){a=void 0===a?{}:a;return Xw.invoke(a)}
;function $w(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||vb(b);this.assets=a.assets||{};this.attrs=a.attrs||vb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
$w.prototype.clone=function(){var a=new $w,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Pa(c)?a[b]=vb(c):a[b]=c}return a};var ax=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function bx(a){a=a||"";if(window.spf){var b=a.match(ax);spf.style.load(a,b?b[1]:"",void 0)}else cx(a)}
function cx(a){var b=dx(a),c=document.getElementById(b),d=c&&Xv(c,"loaded");d||c&&!d||(c=ex(a,b,function(){Xv(c,"loaded")||(Vv(c),Xq(b),sl(Za(Yq,b),0))}))}
...
function dx(a){var b=nf("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
...
u(gx,fx);function hx(a,b,c,d,e){J.call(this);var f=this;this.s=b;this.webPlayerContextConfig=d;this.Wa=e;this.ba=!1;this.api={};this.V=this.o=null;this.K=new K;this.i={};this.P=this.W=this.elementId=this.sa=this.config=null;this.O=!1;this.l=this.F=null;this.ja={};this.Xa=["onReady"];this.lastError=null;this.Ga=NaN;this.I={};this.Ya=new gx(this);this.T=0;this.j=this.m=a;ue(this,this.K);ix(this);jx(this);ue(this,this.Ya);c?this.T=sl(function(){f.loadNewVideoConfig(c)},0):d&&(kx(this),lx(this))}
u(hx,J);l=hx.prototype;l.getId=function(){return this.s};
l.loadNewVideoConfig=function(a){if(!this.h()){this.T&&(window.clearTimeout(this.T),this.T=0);var b=a||{};b instanceof $w||(b=new $w(b));this.config=b;this.setConfig(a);lx(this);this.isReady()&&mx(this)}};
...
function lx(a){if(!a.h()&&!a.O){var b=px(a);if(b&&"html5"===(qx(a)?"html5":null))a.P="html5",a.isReady()||sx(a);else if(tx(a),a.P="html5",b&&a.l&&a.m)a.m.appendChild(a.l),sx(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.F=function(){c=!0;var d=ux(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?nx(a.config):void 0;d&&d(a.m,e,a.webPlayerContextConfig,a.Wa);sx(a)};
a.O=!0;b?a.F():(aw(rx(a),a.F),(b=vx(a))&&bx(b),wx(a)&&!c&&z("yt.player.Application.create",null))}}}
function qx(a){var b=mf(a.elementId);!b&&a.j&&a.j.querySelector&&(b=a.j.querySelector("#"+a.elementId));return b}
function sx(a){if(!a.h()){var b=qx(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.O=!1;if(!ux(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}xx(a)}else a.Ga=sl(function(){sx(a)},50)}}
function xx(a){ix(a);a.ba=!0;var b=qx(a);if(b){a.o=yx(a,b,"addEventListener");a.V=yx(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=yx(a,b,f))}}for(var g in a.i)a.i.hasOwnProperty(g)&&a.o&&a.o(g,a.i[g]);mx(a);a.W&&a.W(a.api);a.K.ra("onReady",a.api)}
...
function ix(a){a.ba=!1;if(a.V)for(var b in a.i)a.i.hasOwnProperty(b)&&a.V(b,a.i[b]);for(var c in a.I)a.I.hasOwnProperty(c)&&window.clearTimeout(Number(c));a.I={};a.o=null;a.V=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function jx(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Xq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){Xq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=ox(this,b);d&&(0<=fb(this.Xa,a)||this.i[a]||(b=zx(this,a),this.o&&this.o(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&sl(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.h()||(b=ox(this,b))&&Bi(this.K,a,b)};
function ox(a,b){var c=b;if("string"===typeof b){if(a.ja[b])return a.ja[b];c=function(){var d=Ka.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){ts(f)}};
a.ja[b]=c}return c?c:null}
function zx(a,b){var c="ytPlayer"+b+a.s;a.i[b]=c;y[c]=function(d){var e=sl(function(){if(!a.h()){try{a.K.ra(b,null!=d?d:void 0)}catch(h){us(new P("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.s,data:d}))}var f=a.I,g=String(e);g in f&&delete f[g]}},0);
rb(a.I,String(e))};
return c}
l.getPlayerType=function(){return this.P||(qx(this)?"html5":null)};
...
l.cancel=function(){this.F&&gw(rx(this),this.F);window.clearTimeout(this.Ga);this.O=!1};
l.B=function(){tx(this);if(this.l&&this.config&&this.l.destroy)try{this.l.destroy()}catch(b){ts(b)}this.ja=null;for(var a in this.i)this.i.hasOwnProperty(a)&&(y[this.i[a]]=null);this.sa=this.config=this.api=null;delete this.m;delete this.j;J.prototype.B.call(this)};
...
function ux(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===fl(c||"","&")[b]}
function nx(a){for(var b={},c=p(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?vb(e):e}return b}
;var Ax={},Bx="player_uid_"+(1E9*Math.random()>>>0);function Cx(a,b){var c="player",d=!1;d=void 0===d?!0:d;c="string"===typeof c?mf(c):c;var e=Bx+"_"+Sa(c),f=Ax[e];if(f&&d)return Dx(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new hx(c,e,a,b,void 0);Ax[e]=f;Xq("player-added",f.api);ve(f,function(){delete Ax[f.getId()]});
return f.api}
...
function Kx(){Ex&&Ex.sendAbandonmentPing&&Ex.sendAbandonmentPing();L("PL_ATT")&&Xw.dispose();for(var a=ei,b=0,c=hw.length;b<c;b++)a.da(hw[b]);hw.length=0;fw("//static.doubleclick.net/instream/ad_status.js");iw=!1;Qk("DCLKSTAT",0);te(Gx,Fx);Ex&&(Ex.removeEventListener("onVideoDataChange",Hx),Ex.destroy())}
;function Lx(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;at()&&Wl(a,b,c)}
...
Lx(d,b,h)}else Lx(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Rh:r;a:{r=void 0===r?Rh:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Ph&&m.Wc(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var w=Qb(r);else{b:if(Ih){try{w=new URL(r)}catch(t){w="https:";break b}w=w.protocol}else c:{w=document.createElement("a");try{w.href=r}catch(t){w=void 0;break c}w=
...
d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Ex=Cx(a,c);Ex.addEventListener("onVideoDataChange",Hx);Ex.addEventListener("onReady",Jx);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?Gx=new Kw(Ex):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(Fx=new Rw(window.parent,a,b),Gx=new Ow(Ex,Fx.connection));jw();M("ytidb_create_logger_embed_killswitch")||M("embeds_web_disable_nwl")||Am();a={};ww||(ww=new vw);ww.install((a.flush_logs={callback:function(){Ir()}},
a));
M("embeds_web_disable_nwl")||xq();M("ytidb_clear_embedded_player")&&ei.S(function(){var e;if(!mv){var f=hr(),g={Fb:lv,uc:kv};f.h.set(g.Fb,g);g={Tb:{feedbackEndpoint:At(gv),modifyChannelNotificationPreferenceEndpoint:At(hv),playlistEditEndpoint:At(iv),subscribeEndpoint:At(ev),unsubscribeEndpoint:At(fv),webPlayerShareEntityServiceEndpoint:At(jv)}};var h=vt.getInstance(),k={};h&&(k.client_location=h);if(void 0===m){nt.h||(nt.h=new nt);var m=nt.h}void 0===e&&(e=f.resolve(lv));Su(g,e,m,k);m={Fb:Yu,vc:Ru.h};
f.h.set(m.Fb,m);mv=f.resolve(Yu)}Uv()})});
var Nx=al(function(){Lu();mt();Cv.h||(Cv.h=new Cv);var a=Cv.h;var b=16623;var c=void 0===c?{}:c;Object.values(Ss).includes(b)||(us(new P("createClientScreen() called with a non-page VE",b)),b=83769);c.isHistoryNavigation||a.h.push({rootVe:b,key:c.key||""});a.o=[];a.v=[];c.Wb?Gv(a,b,c):Hv(a,b,c)}),Ox=al(function(a){M("embeds_web_enable_load_player_from_page_show")&&!a.persisted&&(Lu(),mt())}),Px=al(function(a){M("embeds_web_enable_dispose_player_if_page_not_cached_killswitch")?Kx():a.persisted||(M("embeds_web_enable_load_player_from_page_show")?
Kx():Zc?setTimeout(function(){Kx()},0):Kx())}),Qx=al(Kx);
window.addEventListener?(window.addEventListener("load",Nx),M("embeds_web_enable_load_player_from_page_show")?(window.addEventListener("pageshow",Ox),window.addEventListener("pagehide",Px)):Zc?window.addEventListener("beforeunload",Px):window.addEventListener("pagehide",Px)):window.attachEvent&&(window.attachEvent("onload",Nx),window.attachEvent("onunload",Qx));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Yw);
