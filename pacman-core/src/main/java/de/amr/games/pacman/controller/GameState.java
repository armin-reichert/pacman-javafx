...
public enum GameState implements FsmState<GameModel> {
    ...
    void enableManualPacSteering(boolean enabled) {
        gameController().game().level().ifPresent(level -> level.pac().manualSteering().setEnabled(enabled));
    }
