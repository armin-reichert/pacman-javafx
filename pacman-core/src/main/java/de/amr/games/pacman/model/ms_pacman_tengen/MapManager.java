...
class MapManager {
    ...
    public WorldMap coloredMap(MapCategory mapCategory, int levelNumber) {
    ...
    private WorldMap miniWorldMap(int levelNumber) {
        return switch (levelNumber) {
            ...
            case 26 -> coloredMap(MINI, 2, _04_20_20_VIOLET_WHITE_WHITE);
            case 27 -> coloredMap(MINI, 3, _04_20_20_VIOLET_WHITE_WHITE);
            case 28 -> coloredMap(MINI, 4, NES_ColorScheme.random(), true);
            case 29 -> coloredMap(MINI, 5, NES_ColorScheme.random(), true);
            case 30 -> coloredMap(MINI, 2, NES_ColorScheme.random(), true);
            case 31 -> coloredMap(MINI, 3, NES_ColorScheme.random(), true);
    ...
    private WorldMap bigWorldMap(int levelNumber) {
        return switch (levelNumber) {
            ...
            case 26 -> coloredMap(BIG, 10, _04_20_20_VIOLET_WHITE_WHITE);
            case 27 -> coloredMap(BIG,  8, _04_20_20_VIOLET_WHITE_WHITE);
            case 28 -> coloredMap(BIG,  5, NES_ColorScheme.random(), true);
            case 29 -> coloredMap(BIG,  9, NES_ColorScheme.random(), true);
            case 30 -> coloredMap(BIG,  2, NES_ColorScheme.random(), true);
            case 31 -> coloredMap(BIG, 10, NES_ColorScheme.random(), true);
    ...
    private WorldMap strangeWorldMap(int levelNumber) {
        WorldMap worldMap = switch (levelNumber) {
            ...
            case 26 -> coloredMap(BIG,      9, _03_20_20_VIOLET_WHITE_WHITE);
            case 27 -> coloredMap(STRANGE, 14, _04_20_20_VIOLET_WHITE_WHITE);
            case 28 -> coloredMap(MINI,     5, NES_ColorScheme.random(), true);
            case 29 -> coloredMap(STRANGE,  8, NES_ColorScheme.random(), true);
            case 30 -> coloredMap(MINI,     4, NES_ColorScheme.random(), true);
            case 31 -> coloredMap(STRANGE, 12, NES_ColorScheme.random(), true);
    ...
    private WorldMap coloredMap(MapCategory category, int number, NES_ColorScheme colorScheme, boolean randomColorScheme) {
    ...
    private WorldMap coloredMap(MapCategory category, int number, NES_ColorScheme colorScheme) {
        return coloredMap(category, number, colorScheme, false);
    }
}