...
public enum TengenMapColoring {
    BLACK_WHITE_GREEN(c(0x0f), c(0x20), "007b8c"),
    BLACK_WHITE_YELLOW("000000", c(0x20), c(0x28)),
    BLACK_DARKBLUE("000000", "00298c", c(0x20)),
    BLUE_WHITE_YELLOW("4242ff", c(0x20), c(0x28)),
    BLUE_WHITE(c(0x03), c(0x20), c(0x20)),
    BLUE_YELLOW(c(0x01), c(0x38), c(0x20)),
    BROWN_WHITE("522100", c(0x20), c(0x20)),
    BROWN2_WHITE("994e00", c(0x20), c(0x20)),
    GRAY_WHITE_YELLOW("adadad", c(0x20), c(0x28)),
    GREEN_WHITE_YELLOW("109400", c(0x20), c(0x28)),
    GREEN_WHITE_WHITE("398400", c(0x20), c(0x20)),
    GREEN_WHITE_VIOLET("00424a", c(0x20), "9c18ce"),
    LIGHTBLUE_WHITE_YELLOW("64b0ff", c(0x20), "bcbe00"),
    KHAKI_WHITE("6b6b00", c(0x20), c(0x20)),
    PINK_ROSE("b5217b", "ff6bce", c(0x20)),
    PINK_DARKRED(c(0x36), "b71e7b", c(0x20)),
    PINK_WHITE("ff6bce", c(0x20), c(0x20)),
    PINK_YELLOW("fec4ea", "bcbe00", c(0x20)),
    ...
    VIOLET_WHITE("5a007b", c(0x20), c(0x20)),
