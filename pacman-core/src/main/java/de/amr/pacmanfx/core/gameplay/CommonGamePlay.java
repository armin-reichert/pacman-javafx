...
import de.amr.pacmanfx.core.entities.actor.pac.PacDigestionSystem;
...
public abstract class CommonGamePlay implements GamePlay {
    ...
    public void startNextLevel(GameContext game) {
        ...
        final int lastLevelNumber = game.playConfig().rules().lastLevelNumber();
    ...
    public void update(GameContext game, GameLevel level) {
        ...
        checkIfPacGetsKilled(game.session(), game.playConfig().rules(), session.thisFrame());
    ...
    public void pacEatsGhost(GameContext game, GameLevel level, Ghost ghost) {
        ...
        game.playConfig().systems().ghostState().setState(ghost, GhostState.EATEN);
        //TODO use system
    ...
    public void scorePoints(GameContext game, int points, int levelNumber) {
        ...
        scoreSystem.scorePoints(gameScore, highScore, points, levelNumber, game.playConfig().rules().scoringRules());
