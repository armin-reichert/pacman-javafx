...
import de.amr.pacmanfx.core.event.gameplay.HuntingPhaseStartedEvent;
 ...
 */
public class DefaultHuntingTimer extends TickTimer implements HuntingTimer {
     ...
     */
    public DefaultHuntingTimer(String name, int numPhases) {
        super(name);
    ...
    public void startFirstPhase(GameContext game, int levelNumber) {
        ...
        startPhase(game.playConfig().rules(), levelNumber, 0);
