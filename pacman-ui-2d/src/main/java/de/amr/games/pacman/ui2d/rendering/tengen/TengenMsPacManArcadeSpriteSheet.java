...
public class TengenMsPacManArcadeSpriteSheet implements GameSpriteSheet {

    private final Image mazesImage;
    private final Image spritesImage;

    public TengenMsPacManArcadeSpriteSheet(String resourcePath) {
        ResourceManager rm = this::getClass;
        mazesImage = rm.loadImage(resourcePath + "arcade_mazes.png");
