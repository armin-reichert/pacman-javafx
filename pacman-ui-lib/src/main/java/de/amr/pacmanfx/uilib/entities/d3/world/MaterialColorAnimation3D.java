...
package de.amr.pacmanfx.uilib.entities.d3.world;
...
public class MaterialColorAnimation3D {
    ...
    public static Animation fadeOut(double seconds, PhongMaterial material) {
        return colorTransition(seconds, material, material.getDiffuseColor(), Color.TRANSPARENT);
    }
}
