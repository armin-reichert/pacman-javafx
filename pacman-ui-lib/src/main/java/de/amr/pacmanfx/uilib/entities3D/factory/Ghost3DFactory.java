...
public class Ghost3DFactory {
    ...
    public static void createGhostView3D(
        ...
        GhostComponentMaterialSet materialSet,
        Mesh dressMesh,
        Mesh pupilsMesh,
        Mesh eyeballsMesh)
    {
    ...
    private static void ensureGhostHas3DView(Ghost ghost, GhostSettings settings, GhostComponentMaterialSet materialSet) {
