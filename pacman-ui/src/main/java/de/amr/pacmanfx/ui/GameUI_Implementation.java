...
public class GameUI_Implementation implements GameUI {
    ...
    private static final Set<ActionBinding> DEFAULT_ACTION_BINDINGS = Set.of(
        ...
        new ActionBinding(ArcadeActions.ACTION_INSERT_COIN,     nude(KeyCode.DIGIT5), nude(KeyCode.NUMPAD5)),
        new ActionBinding(ArcadeActions.ACTION_START_GAME,      nude(KeyCode.DIGIT1), nude(KeyCode.NUMPAD1)),
