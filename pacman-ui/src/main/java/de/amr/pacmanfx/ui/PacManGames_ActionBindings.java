...
public interface PacManGames_ActionBindings extends ActionBindingsSupport {
    ...
    Map<GameAction, Set<KeyCombination>> COMMON_ACTION_BINDINGS = Map.ofEntries(
        ...
        createBinding(ACTION_PLAYER_UP,               nude(KeyCode.UP), control(KeyCode.UP)),
        createBinding(ACTION_PLAYER_DOWN,             nude(KeyCode.DOWN), control(KeyCode.DOWN)),
        createBinding(ACTION_PLAYER_LEFT,             nude(KeyCode.LEFT), control(KeyCode.LEFT)),
        createBinding(ACTION_PLAYER_RIGHT,            nude(KeyCode.RIGHT), control(KeyCode.RIGHT)),
