...
public interface UIConfig extends Disposable {
     ...
     */
    Ghost createGhostWithAnimations(SpriteAnimationDriver spriteAnimationDriver, byte personality);
     ...
     */
    AnimationSet createGhostAnimations(SpriteAnimationDriver spriteAnimationDriver, byte personality);
     ...
     */
    AnimationSet createPacAnimations(SpriteAnimationDriver spriteAnimationDriver);
