...
public final class CheatActions {
    ...
    public static final GameAction ACTION_ADD_LIVES = new GameAction("CHEAT_ADD_LIVES") {
        ...
        public void execute(GameUI ui) {
            ...
            game.addLives(3);
            ui.showFlashMessage(ui.globalAssets().translated("cheat_add_lives", ui.context().currentGame().lifeCount()));
        }
    ...
    public static final GameAction ACTION_TOGGLE_IMMUNITY = new GameAction("TOGGLE_IMMUNITY") {
        ...
        public void execute(GameUI ui) {
            ...
            ui.showFlashMessage(ui.globalAssets().translated(immunityOn ? "player_immunity_on" : "player_immunity_off"));
        }
    };
}