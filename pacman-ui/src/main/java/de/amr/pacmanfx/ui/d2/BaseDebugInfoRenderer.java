...
public class BaseDebugInfoRenderer extends BaseRenderer implements GameScene2D_Renderer {
    ...
    public void draw(GameScene2D scene) {
        final State<GameContext> state = scene.appContext().currentGameContext().gameState();
    ...
    public void drawMovingActorInfo(MovingActor movingActor) {
        ...
        if (movingActor.animations() instanceof SpriteAnimationContainer<?> spriteAnimations) {
    ...
    private void drawAnimationInfo(Actor actor, SpriteAnimationContainer<?> spriteAnimationMap, Object selectedID) {
        ctx.save();
