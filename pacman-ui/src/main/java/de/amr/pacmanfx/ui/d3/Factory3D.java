...
public interface Factory3D extends Disposable {
     ...
     */
    Maze3D createMaze3D(UISettings3D globals3D, TerrainLayer terrain, WorldConfig config, WorldMapColorScheme colorScheme, AnimationRegistry animationRegistry);
