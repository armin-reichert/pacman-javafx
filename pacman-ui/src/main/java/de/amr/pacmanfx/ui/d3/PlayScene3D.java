...
public class PlayScene3D extends GameScene implements DisposableGraphicsObject {
    ...
    public PlayScene3D(GameUI ui) {
        super(ui);
        gameOverMessagePicker = new RandomTextPicker(ui.management().translationManager().bundle(), "game.over");
        createSubScene();
        createBindings();
        bindActions();
    ...
    public void updateHUD3D(GameLevel level) {
        ...
        if (score.isEnabled()) {
            ...
            scores3D.showTextForScore(ui.management().translationManager().translate("score.game_over"),
    ...
    private void replaceScores3D() {
        ...
        scores3D = new Scores3D(
            ui.management().translationManager().translate("score.score"),
            ui.management().translationManager().translate("score.high_score"),
