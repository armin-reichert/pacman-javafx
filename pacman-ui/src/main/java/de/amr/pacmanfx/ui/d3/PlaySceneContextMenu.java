 ...
 * {@link Globals3D#PROPERTY_3D_PERSPECTIVE_ID} property. When the property changes
...
public class PlaySceneContextMenu extends ContextMenu implements Disposable {
    ...
    public PlaySceneContextMenu(Game game) {
        ...
        addLocalizedCheckBox(this, translator, GameGlobals.PROPERTY_MINI_VIEW_ON, "pip");
        ...
        for (PerspectiveID id : PerspectiveID.values()) {
            ...
            if (id == Globals3D.PROPERTY_3D_PERSPECTIVE_ID.get()) {
                item.setSelected(true);
            }

            item.setOnAction(_ -> Globals3D.PROPERTY_3D_PERSPECTIVE_ID.set(id));
        }
        ...
        addSeparator(this);
        addLocalizedCheckBox(this, translator, GameGlobals.PROPERTY_MUTED, "muted");
    ...
    @Override
    public void dispose() {
        Globals3D.PROPERTY_3D_PERSPECTIVE_ID.removeListener(perspectiveListener);
    }
}
