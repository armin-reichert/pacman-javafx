...
public class DashboardSectionGameControl extends DashboardSection {
    ...
    public void init(GameUI ui) {
        ...
        setAction(choiceBoxInitialLives, () -> ui.facade().currentGame().setInitialLifeCount(choiceBoxInitialLives.getValue()));
        ...
        cbCollisionCheckedTwice.setOnAction(_ -> {
            final AbstractGameModel game = ui.facade().currentGame();
    ...
    public void update(GameUI ui) {
        ...
        buttonGroupLevelActions[GAME_LEVEL_QUIT] .setDisable(booting || ui.facade().currentGame().optGameLevel().isEmpty());
