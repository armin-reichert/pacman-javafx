...
public class BaseDebugInfoRenderer extends BaseRenderer implements GameScene2D_Renderer {
    ...
    public void drawMovingActorInfo(ActorSpriteAnimController animSystem, GameEntity actor) {
        if (!actor.isVisible()) {
            return;
        }
    ...
    private void drawAnimationInfo(ActorSpriteAnimController animSystem, GameEntity actor, Object selectedID) {
        ctx.save();
