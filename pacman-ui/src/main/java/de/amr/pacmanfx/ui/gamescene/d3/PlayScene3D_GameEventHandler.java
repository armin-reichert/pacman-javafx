...
import de.amr.pacmanfx.uilib.entities.d3.messageview.system.LevelMessageType;
import de.amr.pacmanfx.uilib.entities.d3.messageview.system.MessageView3DAnimationSystem;
import de.amr.pacmanfx.uilib.entities.d3.messageview.system.MessageView3DDisplaySystem;
...
public class PlayScene3D_GameEventHandler implements DefaultGameEventListener {
    ...
    public void onLevelStarted(LevelStartedEvent event) {
        ...
        if (newState instanceof AbstractGameState gameState && gameState.id() instanceof TestStateID) {
            ...
            final MessageView messageView = level.entities().theMessageView();
