 ...
 */
package de.amr.pacmanfx.ui.gamescene.d3.entities.livescounter.system;
...
public class LivesCounterView3DSystem {
    ...
    public static void startTracking(LivesCounter livesCounter, GameEntity gameEntity) {
        ...
        final Pac3DViewComp pac3D =  gameEntity.requireComp(Pac3DViewComp.class);
    ...
    public static void stopTracking(LivesCounter livesCounter) {
        final LivesCounterView3DComp view3D = livesCounter.requireComp(LivesCounterView3DComp.class);
