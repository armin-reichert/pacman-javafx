...
public interface ContextMenuSupport {
    ...
    static MenuItem addLocalizedActionItem(ContextMenu menu, Translator translator, Runnable action, String globalAssetsKey, Object... args) {
    ...
    static MenuItem addLocalizedActionItem(ContextMenu menu, GameUI ui, Translator translator, GameAction action, String globalAssetsKey, Object... args) {
        var actionItem = new MenuItem(translator.translate(globalAssetsKey, args));
        actionItem.setOnAction(_ -> action.executeIfEnabled(ui));
        return add(menu, actionItem);
    }

    static MenuItem addLocalizedTitleItem(ContextMenu menu, Translator translator, String globalAssetsKey, Object... args) {
        return addTitleItem(menu, translator.translate(globalAssetsKey, args));
    }

    static CheckMenuItem addLocalizedCheckBox(ContextMenu menu, Translator translator, BooleanProperty selectionProperty, String globalAssetsKey, Object... args) {
    ...
    static RadioMenuItem addLocalizedRadioButton(ContextMenu menu, Translator translator, String globalAssetsKey, Object... args) {
