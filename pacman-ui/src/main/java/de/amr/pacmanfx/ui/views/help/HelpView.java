...
public class HelpView extends Pane {
    ...
    public void showHelpPopup(GameAppContext appContext, double scaling, String variantName) {
        ...
        final var font = GlobalAssets.Fonts.MONOSPACED.font(Math.max(6, 14 * scaling));
